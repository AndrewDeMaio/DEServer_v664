...
function StartMissionSuccess()
	...
	DEScriptZone:BroadcastSystemMessageInZone(0, "Moving to floor 6.")
...
function OnInitializeVariables(ZoneCreateInfo)
	...
	ZoneCreateInfo.Name = "lilith_5"	
	ZoneCreateInfo.TemplateZoneID = 6150
...
function OnTimer(TimerID)
	...
	if TimerID == 2 then
		WarpToOtherWorldZoneID = DEScriptZone:CreateInstanceDoungeon("OldStone/lilith_6")
