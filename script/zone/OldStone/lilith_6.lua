...
function StartMissionSuccess()
	...
	DEScriptZone:BroadcastSystemMessageInZone(0, "Moving to floor 7.")
...
function OnInitializeVariables(ZoneCreateInfo)
	...
	ZoneCreateInfo.Name = "lilith_6"	
	ZoneCreateInfo.TemplateZoneID = 6160
...
function OnTimer(TimerID)
	...
	if TimerID == 2 then
		WarpToOtherWorldZoneID = DEScriptZone:CreateInstanceDoungeon("OldStone/lilith_7")
