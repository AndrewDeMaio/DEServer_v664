...
function StartMissionSuccess()
	...
	DEScriptZone:BroadcastSystemMessageInZone(0, "Moving to floor 5.")
...
function OnInitializeVariables(ZoneCreateInfo)
	...
	ZoneCreateInfo.Name = "lilith_4"	
	ZoneCreateInfo.TemplateZoneID = 6140
...
function OnTimer(TimerID)
	...
	if TimerID == 2 then
		WarpToOtherWorldZoneID = DEScriptZone:CreateInstanceDoungeon("OldStone/lilith_5")
