...
function StartMissionSuccess()
	...
	DEScriptZone:BroadcastSystemMessageInZone(0, "Moving to floor 9.")
...
function OnInitializeVariables(ZoneCreateInfo)
	...
	ZoneCreateInfo.Name = "lilith_8"	
	ZoneCreateInfo.TemplateZoneID = 6180
...
function OnTimer(TimerID)
	...
	if TimerID == 2 then
		WarpToOtherWorldZoneID = DEScriptZone:CreateInstanceDoungeon("OldStone/lilith_9")
