...
function StartMissionSuccess()
	...
	DEScriptZone:BroadcastSystemMessageInZone(0, "Moving to floor 8.")
...
function OnInitializeVariables(ZoneCreateInfo)
	...
	ZoneCreateInfo.Name = "lilith_7"	
	ZoneCreateInfo.TemplateZoneID = 6170
...
function OnTimer(TimerID)
	...
	if TimerID == 2 then
		WarpToOtherWorldZoneID = DEScriptZone:CreateInstanceDoungeon("OldStone/lilith_8")
