...
public:
    ...
    Attr_t getSTR () { if (m_STR > maxOustersAttr) m_STR = maxOustersAttr; return m_STR; }
	void setSTR (Attr_t str) { if (str > maxOustersAttr) str = maxOustersAttr; m_STR = str; }

	Attr_t getDEX () { if (m_DEX > maxOustersAttr) m_DEX = maxOustersAttr; return m_DEX; }
	void setDEX (Attr_t dex) { if (dex > maxOustersAttr) dex = maxOustersAttr; m_DEX = dex; }

	Attr_t getINT () { if (m_INT > maxOustersAttr) m_INT = maxOustersAttr; return m_INT; }
	void setINT (Attr_t inte) { if (inte > maxOustersAttr) inte = maxOustersAttr; m_INT = inte; }
