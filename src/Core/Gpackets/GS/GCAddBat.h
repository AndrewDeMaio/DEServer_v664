...
public:
	...
	*/
	...
	Color_t getAdvanceColor() const throw() { return m_AdvanceColor; }
	void setAdvanceColor(Color_t color) throw() { m_AdvanceColor = color; }
...
private:
	...
	*/
	...
	Color_t	 	 m_AdvanceColor;     // 2007.07.24 승직 박쥐 색깔
