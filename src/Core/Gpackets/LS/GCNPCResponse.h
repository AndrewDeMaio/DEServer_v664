...
enum 
{
	...
	NPC_NOT_ENOUGH_SOCCER_BALL,							// 축구 이벤트 아이템이 충분하지 않습니다.

	NPC_NOT_ENOUGH_EXCHANGE_SEALING_STONE,				// 봉인석으로 교환할 아이템이 부족합니다.
	...
	NPC_RESPONSE_NOT_ENTER_SURVIVAL_ZONE,				// 이벤트 경기장의 인원이 가득 찾다.

	NPC_RESPONSE_GIVE_GAMBLE_ITEM_OK,					// 겜블아이템을 주웠다.
	NPC_RESPONSE_GAMBLE_INIT_OK,						// 겜블 정보 초기화 완료 

	NPC_NOT_ENOUGH_EVENT_ITEM,							// 이벤트 아이템이 부족합니다
	NPC_RESPONSE_NOT_ENOUGH_ITEM,						// 아이템이 부족합니다.
	...
	NPC_RESPONSE_BLITZ_COUPON,							// 20080829 블리츠 문양 이벤트 관련 메세지
	NPC_RESPONSE_BLITZ_REWARD_OK,								// 20080902 블리츠 문양 이벤트 보상 관련 메세지, 어떤 아이템이 생성됐는지 알 수 있다. 다른 메세지에도 이걸 쓰길
	
	NPC_RESPONSE_REPAIR_FAIL_NOT_NEED,
	
	NPC_RESPONSE_MAX	// 138
};
...
private: 
	//20090602 ksym555 의도된 사이즈와 틀려서 타입변경 WORD -> BYTE
	BYTE m_Code;
	uint m_Parameter;
