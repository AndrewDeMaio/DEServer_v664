...
public :
	...
	PacketSize_t getPacketSize() const throw() { return szObjectID + szNPCID + szShopVersion*3 + szMarketCond; }
...
public :
	...
	PacketSize_t getPacketMaxSize() const throw() { return szObjectID + szNPCID + szShopVersion*3 + szMarketCond; }
