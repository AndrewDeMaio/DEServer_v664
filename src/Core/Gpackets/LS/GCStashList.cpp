...
#ifdef VERSION_THIRD_ENCHANT_1
			m_pItems[rack][index].ThirdOptionType   = pItem->getThirdOptionTypeList();
			m_pItems[rack][index].ThirdEnchantType   = pItem->getThirdEnchantType();
#endif
#ifdef INTERNATIONAL_PREMIUM_SERVICE
			m_pItems[rack][index].cashItem   = pItem->getCashItemType();
#endif
			break;
