...
public :
	...
	PacketSize_t getPacketSize() const throw() { return szSkillType + szObjectID + szItemClass + szItemType + szCEffectID + szCoordInven* 2
	...
	void setItemClass(ItemClass_t IClass) throw() { m_ItemClass = IClass; }
...
public :
	...
	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const throw() { return szSkillType + szObjectID + szItemClass + szItemType + szCEffectID + szCoord* 2
