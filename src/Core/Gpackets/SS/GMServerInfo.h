...
typedef struct _ZONEUSERDATA
{
	...
	//종족별 인원체크. kim sung yong 20071205
	WORD	 RaceNum[3];
...
public :
	...
	PacketSize_t getPacketSize () const throw () { return szWorldID + szBYTE + szBYTE + m_ZoneCount*sizeof(ZONEUSERDATA); }
...
public:
	...
	void addZoneUserData(ZoneID_t ZoneID, DWORD value, vector<uint> RaceNum ) throw();
...
public :
	...
	PacketSize_t getPacketMaxSize() const throw() { return szWorldID + szBYTE + szBYTE + 255*sizeof(ZONEUSERDATA); }
