...
public :
	...
	PacketSize_t getPacketSize() const throw() { return szuint + szuint + szBYTE + m_Message.size() + szBYTE; }
//	PacketSize_t getPacketSize() const throw() { return szuint + szBYTE + m_Message.size() + szBYTE; }
	...
	uint getType() const throw() { return m_Type; }
	void setType( uint Type ) throw() { m_Type = Type; }
...
public :
	...
	PacketSize_t getPacketMaxSize() const throw() { return szuint + szuint + szBYTE + 128 + szBYTE ; }
