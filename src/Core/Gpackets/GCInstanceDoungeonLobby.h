...
typedef vector<InstanceDoungeonInfo *> TInstanceDoungeonInfo;
typedef vector<InstanceDoungeonInfo *>::const_iterator TInstanceDoungeonInfoItr;
...
public :
	...
	{ 
		return m_DoungeonList.push_back(pInstanceDoungeonInfo); 
	}
