	...
	throw ( ProtocolException , Error )
{
	...
	try 
	{
		...
		// 20070907 슬레 망각의 수정땜시 추가
		iStream.read( m_AdvancedSTR );
		iStream.read( m_AdvancedDEX );
		iStream.read( m_AdvancedINT );
...
//		cout << m_RankExp << endl;
		...
		// 20070907 슬레 망각의 수정땜시 추가
		oStream.write( m_AdvancedSTR );
		oStream.write( m_AdvancedDEX );
		oStream.write( m_AdvancedINT );
	...
	throw ()
{
	...
	msg << ",Sight:" << (int)m_Sight
		...
		<< ",AdvancedSTR:" << (int)m_AdvancedSTR
		<< ",AdvancedDEX:" << (int)m_AdvancedDEX
		<< ",AdvancedINT:" << (int)m_AdvancedINT
		<< ")";
