...
//	2007 05 16
    ...
    Attr_t getSTR () { if (m_STR > maxVampireAttr) m_STR = maxVampireAttr; return m_STR; }
	void setSTR (Attr_t str) { if (str > maxVampireAttr) str = maxVampireAttr; m_STR = str; }

	Attr_t getDEX () { if (m_DEX > maxVampireAttr) m_DEX = maxVampireAttr; return m_DEX; }
	void setDEX (Attr_t dex) { if (dex > maxVampireAttr) dex = maxVampireAttr; m_DEX = dex; }

	Attr_t getINT () { if (m_INT > maxVampireAttr) m_INT = maxVampireAttr; return m_INT; }
	void setINT (Attr_t inte) { if (inte > maxVampireAttr) inte = maxVampireAttr; m_INT = inte; }
