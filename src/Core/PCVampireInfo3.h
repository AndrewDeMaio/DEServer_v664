...
public:
	...
	enum VampireColors 
	{
		...
		VAMPIRE_COLOR_WINGBODY,
		VAMPIRE_COLOR_WINGEFFECT,
...
public:
	...
	void setAdvanceBatColor (Color_t advbatColor) throw () { m_Colors[VAMPIRE_COLOR_ADVANCE_BAT] = advbatColor; }
	...
	void setBatType(BYTE Type) { m_BatType = Type; }

	ItemType_t getWingItemType() { return m_WingItemType; }
	void setWingItemType(ItemType_t ItemType) { m_WingItemType = ItemType; }
	
	Color_t getWingBodyColor() { return m_Colors[VAMPIRE_COLOR_WINGBODY]; }
	void setWingBodyColor(Color_t Color) { m_Colors[VAMPIRE_COLOR_WINGBODY] = Color; }

	Color_t getWingEffectColor() { return m_Colors[VAMPIRE_COLOR_WINGEFFECT]; }
	void setWingEffectColor(Color_t Color) { m_Colors[VAMPIRE_COLOR_WINGEFFECT] = Color; }
