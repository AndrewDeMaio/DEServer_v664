...
public:
	...
	PCOustersInfo3 (const PCOustersInfo3 & oustersInfo) throw ()
		...
		m_Sex(oustersInfo.m_Sex), m_CoatType(oustersInfo.m_CoatType), m_ArmType(oustersInfo.m_ArmType), 
...
public:
	...
	void setWingBodyColor(Color_t Color) throw () { m_Colors[OUSTERS_COLOR_WINGEFFECT] = Color; }

	Color_t getWingEffectColor() const throw () { return m_Colors[OUSTERS_COLOR_WINGBODY]; }
