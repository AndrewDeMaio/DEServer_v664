...
public:
	...
	bool isChildren() const throw() { return m_bChildren; }
	void setChildren(bool children) throw() { m_bChildren= children; }
...
public:
	...
	PacketSize_t getPacketMaxSize() const throw() { return szint + 2048 + szBYTE + 32 + 6 + szBYTE; }
