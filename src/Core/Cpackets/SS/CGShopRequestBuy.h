...
public:
	...
	static void executeNormal(CGShopRequestBuy* pPacket, Player* player, Item* pItem) throw(ProtocolException, Error);
	static void executeMotorcycle(CGShopRequestBuy* pPacket, Player* player, Item* pItem) throw(ProtocolException, Error);
	static void executeEvent(CGShopRequestBuy* pPacket, Player* player, Item* pItem) throw(ProtocolException, Error);
};
