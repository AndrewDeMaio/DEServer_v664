	 ...
	 throw (ProtocolException , Error)
{
	...
	pNPCBase = GetNPCCreature(pPC, NPCID);
	...
	*/
	...
	if (pNPC->getShopType() == SHOPTYPE_NORMAL)
	{
		...
		{
			executeMotorcycle(pPacket, pPlayer, pItem);
		}
		else 
		{
			executeNormal(pPacket, pPlayer, pItem);
		}
	}
...
//////////////////////////////////////////////////////////////////////
	...
	else if (pNPC->getShopType() == SHOPTYPE_EVENT)
	{
		...
		executeEvent(pPacket, pPlayer, pItem);
	}
#endif
...
// 일반 아이템의 구입을 처리한다.
//////////////////////////////////////////////////////////////////////////////
void CGShopRequestBuyHandler::executeNormal (CGShopRequestBuy* pPacket , Player* pPlayer, Item* pItem)
	 throw (ProtocolException , Error)
{
	__BEGIN_TRY __BEGIN_DEBUG_EX
...
//			int NewItemMoney = getPercentValue((int)itemMoney, itemTaxRatio);
			...
			// 이제 30%는 서버가 떼먹기로 했음. by bezz. 2006.08.17
			itemTax = (int)(( NewItemMoney - itemMoney ) * 0.7);
...
// 모터 사이클의 구입을 처리한다.
//////////////////////////////////////////////////////////////////////////////
void CGShopRequestBuyHandler::executeMotorcycle (CGShopRequestBuy* pPacket , Player* pPlayer, Item* pItem)
	 throw (ProtocolException , Error)
{
	__BEGIN_TRY __BEGIN_DEBUG_EX
...
// 이벤트 아이템의 구입을 처리한다.
//////////////////////////////////////////////////////////////////////////////
void CGShopRequestBuyHandler::executeEvent(CGShopRequestBuy* pPacket , Player* pPlayer, Item* pItem)
	 throw (ProtocolException , Error)
{
	__BEGIN_TRY __BEGIN_DEBUG_EX
