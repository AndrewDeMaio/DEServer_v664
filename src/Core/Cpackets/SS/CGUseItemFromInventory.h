...
protected:
	...
	static void executePremiumService(CGUseItemFromInventory* pPacket, Player* pPlayer, int iPremiumDay) throw (ProtocolException, Error); // 20080926
	static Turn_t executePremiumServiceUseStart(CGUseItemFromInventory* pPacket, Player* pPlayer, const string & name , ItemType_t itemType ) throw (ProtocolException, Error); // 20080926
	static bool executePremiumServiceOverDay(Player* pPlayer, int iDayCount) throw (ProtocolException, Error); // 20080926
	static void executeCallNPCCard(CGUseItemFromInventory* pPacket, Player* pPlayer);
};
