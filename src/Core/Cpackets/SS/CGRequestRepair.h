...
public:
	...
	static void executeNormal(CGRequestRepair* pPacket, Player* player, double dRepairDiscountRate = 0.0) throw(ProtocolException, Error);
	static void executeMotorcycle(CGRequestRepair* pPacket, Player* player, double dRepairDiscountRate = 0.0) throw(ProtocolException, Error);
	static void executeAll(CGRequestRepair* pPacket, Player* player, double dRepairDiscountRate = 0.0) throw(ProtocolException, Error);
};
