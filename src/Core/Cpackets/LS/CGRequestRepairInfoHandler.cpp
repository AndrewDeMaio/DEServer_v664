	 ...
	 throw (ProtocolException , Error)
{
	...
	else
	{
		...
		if (pItem != NULL)
		{
			...
			{
				executeNormal(pPacket, pPlayer, dRepairDiscountRate);
			}
		}
	}
...
// 일반 아이템을 처리한다.
//////////////////////////////////////////////////////////////////////////////
void CGRequestRepairInfoHandler::executeNormal (CGRequestRepairInfo* pPacket , Player* pPlayer, double dRepairDiscountRate)
	 throw (ProtocolException , Error)
{
	__BEGIN_TRY __BEGIN_DEBUG_EX
	...
	repairDiscountPrice = PriceManager::GetDiscountPrice(repairPrice, dRepairDiscountRate);
...
// 모터 사이클을 처리한다.
//////////////////////////////////////////////////////////////////////////////
void CGRequestRepairInfoHandler::executeMotorcycle (CGRequestRepairInfo* pPacket , Player* pPlayer, double dRepairDiscountRate)
	 throw (ProtocolException , Error)
{
	__BEGIN_TRY __BEGIN_DEBUG_EX
...
// 모든 아이템 수리하기
//////////////////////////////////////////////////////////////////////////////
void CGRequestRepairInfoHandler::executeAll(CGRequestRepairInfo* pPacket , Player* pPlayer, double dRepairDiscountRate)
	 throw (ProtocolException , Error)
{
	__BEGIN_TRY __BEGIN_DEBUG_EX
