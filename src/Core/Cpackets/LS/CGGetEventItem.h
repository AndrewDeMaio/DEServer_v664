...
public:
	...
	static void executeComebackItem200507(CGGetEventItem* pPacket, Player* pPlayer) throw(ProtocolException, Error);
	static void executeComebackPremiumItem200507(CGGetEventItem* pPacket, Player* pPlayer) throw(ProtocolException, Error);
	static void executeComebackRecommendItem200507(CGGetEventItem* pPacket, Player* pPlayer) throw(ProtocolException, Error);
#endif
};
