...
//	bool CheckRequiredSkill(SkillInfo* pSkillInfo, Ousters* pOusters, int domain); 20080402 SkillUtil 쪽으로 옮겼다.
...
//#ifdef __TEST_SERVER__
		...
		case SKILL_SWORD_COMBO:
		case SKILL_BLADE_COMBO:
		case SKILL_VAMPIRE_COMBO:
		case SKILL_OUSTERS_COMBO:
			
		case SKILL_MAGMA_DETONATION_1:
		case SKILL_MAGMA_DETONATION_2:
		case SKILL_SQUALLY_BARRIER1:
		case SKILL_SQUALLY_BARRIER2:
//#endif
#endif
			break;
		////////////////////////////////////////////////////////////
	...
	throw(ProtocolException, Error)
{
	...
	else if (pSkillInfo->getLevel() > pOusters->getLevel())
	{
		GCLearnSkillFailed failpkt; 
		failpkt.setSkillType(targetSkillType);;
		failpkt.setDesc(PARENT_SKILL_NEED);
