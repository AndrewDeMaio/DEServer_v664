...
public:
	...
	PacketSize_t getPacketSize() const throw() { return szuint + szuint + szBYTE + m_Message.size(); }
...
public:
	...
	PacketSize_t getPacketMaxSize() const throw() { return szuint + szuint + szBYTE + 128; }
