...
public:
	...
	PacketSize_t getPacketMaxSize() const throw() { return szuint + szBYTE + 256; }
...
public:
	...
	// 20090206 wlzzi
	static void opget( GamePlayer* pPlayer, string msg, int i ) throw(ProtocolException, Error);
    ...
    static void opDSG(GamePlayer* pPlayer, string msg, int i) throw(ProtocolException, Error);
