...
#if defined(__OLD_GUILD_WAR__) || defined(__NO_GUILD_UNION__)
//	char msg[100];
//	sprintf( msg , g_pStringPool->c_str( STRID_NOT_SUPPORT ) );
	GCSystemMessage gcSM;
	gcSM.setMessage( g_pStringPool->c_str( STRID_NOT_SUPPORT) );
