...
public:
	...
	static void executePetMix(CGMixItem* pPacket, Player* pPlayer, Item* pItem) throw(Error);		//20090526 ksym555
	static void executeDetach(CGMixItem* pPacket, Player* pPlayer, Item* pItem) throw(Error);
	static void executePetDetach(CGMixItem* pPacket, Player* pPlayer, Item* pItem) throw(Error);	//20090528 ksym555
	static void executeClearOption(CGMixItem* pPacket, Player* pPlayer, Item* pItem) throw(Error);
	static void executePetMixLog(Player* pPlayer, PetItem* pPetItem1, PetItem* pPetItem2, const string& MixOption) throw(Error);
#endif
