	 ...
	 throw (ProtocolException , Error)
{
	...
	try 
	{
		...
		// getGameWorldInfo() is 1-based, so indices 1..Num must be valid.
		// This was aWorldInfo[Num], which made aWorldInfo[Num] a stack overflow.
		...
		for(int i = 1 ; i < Num + 1; i++) 
		{
			...
			// Unregistered world id -- skip rather than dereference NULL.
