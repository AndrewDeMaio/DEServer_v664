...
//////////////////////////////////////////////////////////////////////
void SocketInputStream::readPacket ( Packet * pPacket, bool bSkipHeader )  
	throw ( ProtocolException , Error )
{
	__BEGIN_TRY
	...
	//add by kim 패킷로그.
	cout << "[SocketInput]Recv Packet:" << pPacket->toString() <<",PacketID:"<<pPacket->getPacketID()<< ",size:" << pPacket->getPacketSize() << endl;
	
//#ifdef __PACKET_LOG__
	filelog("Packet.log", "Recv Packet ID : [%d]", pPacket->getPacketID());
	cout << "Recv Packet ID : [" << pPacket->getPacketID() << "]" << endl;
//#endif
