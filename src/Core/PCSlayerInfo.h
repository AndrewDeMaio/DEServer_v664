...
public:
	...
	// get/set STR
	Attr_t getSTR () { if (m_STR > maxSlayerAttr) m_STR = maxSlayerAttr; return m_STR; }
	void setSTR (Attr_t str) { if (str > maxSlayerAttr) str = maxSlayerAttr; m_STR = str; }

	// get/set DEX
	Attr_t getDEX () { if (m_DEX > maxSlayerAttr) m_DEX = maxSlayerAttr; return m_DEX; }
	void setDEX (Attr_t dex) { if (dex > maxSlayerAttr) dex = maxSlayerAttr; m_DEX = dex; }

	// get/set INT
	Attr_t getINT () { if (m_INT > maxSlayerAttr) m_INT = maxSlayerAttr; return m_INT; }
	void setINT (Attr_t inte) { if (inte > maxSlayerAttr) inte = maxSlayerAttr; m_INT = inte; }
