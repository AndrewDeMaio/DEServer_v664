...
//	void addListElement(EffectID_t EffectID, WORD len) throw(); 
	void addListElement(EffectID_t EffectID, DWORD len) throw(); 
	...
	const pair<EffectID_t, DWORD> popFrontListElement() throw() { pair<EffectID_t, DWORD> ret = m_EList.front(); m_EList.pop_front(); return ret; }
...
protected :
	...
	// Status List
	list<pair<EffectID_t, DWORD> > m_EList;
