...
public :
	...
	// get/set MaxUser 2008.02.14  kim Sung Yong
	uint getMaxUser () const throw () { return m_MaxUser; }
	void setMaxUser( uint MaxUser ) throw () { m_MaxUser = MaxUser; }
...
private :
	...
	// Max User 2008.02.14  Kim Sung Yong
	uint m_MaxUser;
