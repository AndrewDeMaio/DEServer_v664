...
public:
	...
	virtual Packet* getAddPacket() const = 0;
...
public:
	...
	//      를 실행하게 된당... -_-;
	////////////////////////////////////////////////////////////
	virtual void setXY(ZoneCoord_t x, ZoneCoord_t y) throw() { m_X = x; m_Y = y; }
	virtual void setXYDir(ZoneCoord_t x, ZoneCoord_t y, Dir_t dir) throw() { setXY(x, y); m_Dir = dir; }
...
//	20080502 도메인 경험치 땜시 추가
	ObjectID_t getEnemyTarget() { return m_EnemyTarget; }
	virtual void setEnemyTarget(ObjectID_t value) { m_EnemyTarget = value; }

	Viewable* getViewable() const { return m_pViewable; }
	ViewAbility* getViewAbility() const { return m_pViewAbility; }

	void setCanAddEffectFlag(Effect::EffectClass EClass);
	void resetCanAddEffectFlag(Effect::EffectClass EClass);

	void setCanAddAllEffectFlag();
	void resetCanAddAllEffectFlag();
...
protected:
	...
	bitset<Effect::EFFECT_CLASS_MAX> m_CanAddEffectFlag;         // 추가 가능한 Effect
	...
	ObjectID_t						 m_EnemyTarget; // 20080502 도메인 경험치 땜시 추가
	

	Viewable*						m_pViewable;
	ViewAbility*					m_pViewAbility;
