...
public:
	...
	virtual void init() = 0;
	void clear() { SAFE_DELETE(m_pStateFactory); }
...
{
public:
	typedef hash_map<DWORD,State*>			HashMapState;
	typedef HashMapState::iterator			HashMapStateItr;
	typedef HashMapState::const_iterator	HashMapStateConstItr;

public:
	~FlyweightStateFactory();
