	...
	throw(Error)
{
	...
	os << "INSERT INTO EffectSafeForceScroll ( OwnerID, RemainTime ) VALUES(" 
		<< "'" << ownerID.c_str()
		<< "'," << remainTurn << ")";
	...
	throw(Error)
{
	...
	os << "DELETE FROM EffectSafeForceScroll WHERE OwnerID = '" << ownerID.c_str() << "'";
	...
	throw(Error)
{
	...
	os << "UPDATE EffectSafeForceScroll SET "
