...
enum StringID
{
	...
	// 20070814 지금부터 %d분간 경험치가 2배로 적용됩니다.
	STRID_EXP_2X_START = 380,   // 380
	// 20070814 지금부터 %d분간 특정 몬스터가 2배 많이 출현합니다.
	STRID_MONSTER_2X_START,     // 381
	// 20070814 지금부터 %d분간 계급 경험치가 2배로 적용됩니다.
	STRID_RANK_EXP_2X_START,    // 382
	// 20070814 지금부터 %d분간 행운이 2배로 적용됩니다.
	STRID_LUCK_2X_START,        // 383
	// 20070814 지금부터 %d분간 몬스터를 사냥하면 특정 확률로 특수한 아이템이 드랍됩니다.
	STRID_SPECIAL_ITEM_START,   // 384
	// 20070814 경험치가 2배로 적용되는 시간이 종료되었습니다.
	STRID_EXP_2X_END,           // 385
	// 20070814 몬스터가 2배로 출현하는 시간이 종료되었습니다.
	STRID_MONSTER_2X_END,       // 386
	// 20070814 계급 경험치가 2배로 적용되는 시간이 종료되었습니다.
	STRID_RANK_EXP_2X_END,      // 387
	// 20070814 행운이 2배로 적용되는 시간이 종료되었습니다.
	STRID_LUCK_2X_END,          // 388
	// 20070814 특수한 아이템이 드랍되는 시간이 종료되었습니다.
	STRID_SPECIAL_ITEM_END,     // 389

	STRID_SET_RICE_CAKE_EVENT,		// 390
	
	// 20070814 전쟁신청중에는 추방시킬 수 없다.
	STRID_CANNOT_KICK_DURING_JOIN_WAR, // 391 
	// 20070814 전쟁신청중에는 길드마스터를 변경할 수 없다.
	STRID_CANNOT_CHANGE_GUILD_MASTER_DURING_JOIN_WAR, // 392
	// 20070814 권한을 이임하기에는 레벨이 부족합니다.
	STRID_LOW_LEVEL_CHANGE_GUILD_MASTER, // 393
	// 20070814 권한을 이임하기에는 레벨이 부족합니다.
	STRID_LOW_FAME_CHANGE_GUILD_MASTER, // 394
	// 20070814 권한을 이임할 수 없는 캐릭터입니다.
	STRID_NOT_ALLOW_CHARACTER_CHANGE_GUILD_MASTER, // 395
	// 20070814 전쟁신청중에는 길드를 탈퇴 할 수 없다.
	STRID_CANNOT_LEAVE_DURING_JOIN_WAR, // 396
	// 20070814 사용할 수 없는 징표입니다.
	STRID_CANNOT_USE_MARK, // 397
	// 20070814 빈 슬롯이 없습니다.
	STRID_NOT_EMPTY_SLOT, // 398
	// 20070814 이미 장착하고 있는 징표입니다.
	STRID_ALREADY_EQUIP_MARK, // 399
	// 20070814 피의 성서 징표가 장착되었습니다.
	STRID_EQUIPED_BLOOD_BIBLE_MARK, // 400
	// 20070814 아직 펫 퀘스트를 할 수 있는 레벨이 되지 않았습니다.
	STRID_LOW_LEVEL_PET_QUEST, // 401
	// 20070814 공성전 중에만 입장하실 수 있습니다.
	STRID_OLNY_CAN_ENTER_DURING_GUILD_WAR, // 402
	// 20070814 타입 1 서버 오류입니다. 운영팀에 문의하세요.
	STRID_ERROR_TYPE1_ASK_SERVER_MANAGER, // 403
	// 20070814 전쟁에 참가한 길드가 아닙니다.
	STRID_NOT_GUILD_ENTER_WAR, // 404
	// 20070814 길드 마스터만 가능합니다.
	STRID_ONLY_CAN_GUILD_MASTER, // 405
	// 20070814 더 이상 전환할 수 없습니다.
	STRID_CANNOT_PROCESS_ANYMORE, // 406
	// 20070814 정상적으로 전환되었습니다. 전환 가능 포인트가 %d 포인트 남았습니다.
	STRID_CHANGE_OK_REMAIN_POINT, // 407
	// 20070814 더 이상 능력치를 초기화 할 수 없습니다.
	STRID_CANNOT_ANYMORE_RESET_ABILITY_POINT, // 408
	// 20070814 능력치를 초기화 하였습니다. %d 회 더 초기화 할 수 있습니다.
	STRID_RESET_ABILITY_POINT_REMAIN_POINT, // 409
	// 20070814 15개의 퀘스트 아이템이 필요합니다.
	STRID_NEED_15_QUEST_ITEM, // 410
	// 20070814 보상 아이템을 지급했습니다.
	STRID_GIVE_REWARD_ITEM, // 411
	// 20070814 질드레 레어가 열리지 않았습니다.
	STRID_GDR_LAIR_NOT_OPEN, // 412
	// 20070814 러스트 타워 2층에서 하이메스 맹인석상을 부수고 와야 합니다.
	STRID_DESTROY_STONE_MANGIN_AT_LUST_TOWER2, // 413
	// 20070814 %s님이 소울 체인을 시전합니다. 10초 이후 도착합니다.
	STRID_CAST_SOULCHAIN_ARRIVE_10_SECOND, // 414
	// 20070814 스킬에 실패 하였습니다.
	STRID_FAILED_CAST_SKILL, // 415
	// 20070814 깨끗한 가죽을 얻었습니다.
	STRID_GET_CLEAN_SKIN, // 416
	// 20070814 손상된 가죽을 얻었습니다.
	STRID_GET_HURT_SKIN, // 417
	// 20070814 가죽을 얻지 못 했습니다.
	STRID_NOT_GET_SKIN, // 418
	// 20070814 가죽 벗기기에 실패 하였습니다.
	STRID_FAILD_SKILL_GET_SKIN, // 419
	// 20070814 아테네 금메달을 1개 획득했습니다. 넷마블 이벤트 페이지에서 상품을 확인하세요.
	STRID_GET_GOLD_MEDAL_CHECK_EVENTPAGE, // 420
	// 20070814 이벤트 복권이 %d개가 되었습니다. 자세한 내용은 홈페이지를 참조하세요.
	STRID_GET_EVENT_LOTTO_CHECK_HOMEPAGE, // 421
	// 20070814 이벤트 퀘스트 제한 시간이 %d시간 %d분 남았습니다.
	STRID_REMAIN_LIMIT_TIME_EVENT_QUEST, // 422
	// 20070814 12시간이 지났습니다. A등급 퀘스트를 다시 신청하실 수 있습니다.
	STRID_YOU_CAN_A_LEVEL_QUEST, // 423
	// 20070814 %d분 뒤에 질드레 레어 입구가 닫힙니다.
	STRID_CLOSE_GDR_LAIR_AFTER_TIME, // 424
	// 20070814 질드레 레어 입구가 닫혔습니다.
	STRID_CLOSED_GDR_LAIR, // 425
	// 20070814 제한 시간이 %d 분 남았습니다.
	STRID_REMAIN_MINUTE_LIMIT_TIME, // 426
	// 20070814 제한 시간이 경과했습니다. 10초 후 부활위치로 이동합니다.
	STRID_PASSED_LIMIT_TIME_MOVE_REVIVE_POINT, // 427
	// 20070814 슬레이어의 최강 서바이벌 존이 열렸습니다.
	STRID_OPEN_SLAYER_TOP_SURVIVAL_ZONE, // 428
	// 20070814 뱀파이어의 최강 서바이벌 존이 열렸습니다.
	STRID_OPEN_VAMPIRE_TOP_SURVIVAL_ZONE, // 429
	// 20070814 아우스터즈의 최강 서바이벌 존이 열렸습니다.
	STRID_OPEN_OUSTERS_TOP_SURVIVAL_ZONE, // 430
	// 20070814 지금부터 10분 동안만 서바이벌 존에 입장 가능합니다.
	STRID_CAN_ENTER_SURVIVAL_ZONE_TEN_MINUTE, // 431
	// 20070814 서바이벌 존이 열렸습니다.
	STRID_OPEN_SURVIVAL_ZONE, // 432
	// 20070814 서바이벌 입장시간이 %u분 남았습니다.
	STRID_REMAIN_TIME_CAN_ENTER_SURVIVAL_ZONE, // 433
	// 20070814 서바이벌이 시작되었습니다.
	STRID_START_SURVIVAL, //434
	// 20070814 지금부터 서버이벌 존에 입장이 불가능 합니다.
	STRID_CANNOT_ENTER_SURVIVAL_ZONE_NOW, // 435
	// 20070814 지금부터 경기장 중앙에서 멀어질수록 큰 데미지를 입습니다.
	STRID_BIG_DAMAGE_FAR_CENTER_NOW, // 436
	// 20070814 에지아크가 해제 되었습니다.
	STRID_CLOSED_EDGE_ARC, // 437
	// 20070814 서바이벌이 종료 되었습니다.
	STRID_END_SURVIVAL, // 438
	// 20070814 지금부터 %d분 뒤 경기장 중앙에서 멀어질수록 큰 데미지를 입는 에지아크에 걸리게 됩니다.
	STRID_AFTER_MINUTE_BIG_DAMAGE_FAR_CENTER_EDGE_ARC, // 439
	//20070814 현재 %d명이 생존해 있습니다.
	STRID_LIVE_PLAYER_NOW, // 440
	//20070814 질드레 레어가 열렸습니다.
	STRID_OPEN_GDR_LAIR, // 441
	// 20070814 일루전스 웨이를 통과하지 못했습니다. 10초 후 부활위치로 이동합니다.
	STRID_CANNOT_ENTER_ILLUSION_WAY_MOVE_REVIVE_POINT, // 442
	// 20070814 질드레 레어 공략에 실패했습니다. 10초 후에 부활 위치로 이동됩니다.
	STRID_FAILED_GDR_LAIR_ATTACK_MOVE_REVIVE_POINT, // 443
	// 20070814 도메인 경험치를 획득했습니다.
	STRID_GET_DOMAIN_EXP, // 444
	// 20070814 아이템을 획득했습니다.
	STRID_GET_ITEM, // 445
	// 20070814 %ld레이를 획득했습니다.
	STRID_GET_RAY, // 446
	// 20070814 %ld겔드를 획득했습니다.
	STRID_GET_GELD, // 447
	// 20070814 %ld자드를 획득했습니다.
	STRID_GET_ZARD, // 448
	// 20070814 경험치를 획득했습니다.
	STRID_GET_EXP, // 449
	// 20070814 퀘스트 아이템을 획득했습니다.
	STRID_GET_QUEST_ITEM, // 450
	// 20070814 퀘스트 아이템을 잃었습니다.
	STRID_LOST_QUEST_ITEM, // 451
	// 20070814 %u회 흡혈했습니다.
	STRID_TIMES_BLOODSUCKING, // 452
	// 20070814 %u회 흡영했습니다.
	STRID_TIMES_ABSORB_ENERGY, // 453
	// 20070814 2분 후에 %s타워의 몬스터가 출현 합니다
	STRID_2MINUTE_LATER_APPEAR_HELLGARDEN_MONSTER, // 454
	// 20070814 타워 %d층 제한시간 [%d]
	STRID_HELLGARDEN_TOWER_LIMITED_TIME, // 455
	// 20070814 %s타워의 출입이 허용되었습니다.
	STRID_CAN_ENTER_HELLGARDENTOWER, // 456
	// 20070814 10초 후에 %s %d층으로 이동합니다.
	STRID_AFTER_10SECOND_MOVE_HELLGARDENTOWER_FLOWER, // 457
	// 20070814 인벤토리에 여유공간이 없어 %s를 획득하지 못하였습니다.
	STRID_NOT_ENOUGH_INVENTORY_SPACE_NOT_GET_ITEM, // 458
	// 20070814 %s타워의 출입이 제한 되었습니다.
	STRID_CANNOT_ENTER_HELLGARDENTOWER, // 459
	// 20070814 미클리즈가 라옴던전 5층에서 부활하려 합니다.
	STRID_SOON_MIKLLIZZ_REVIVE_RAOM_DUNGEON5, // 460
	// 20070814 지금부터 30분 동안만 라움던전 5층에 입장이 가능합니다.
	STRID_CAN_ENTER_RAOM_DUNGEON_30MINUTE, // 461
	// 20070814 라옴 던전 5층이 %d분 후에 폐쇄됩니다.
	STRID_CLOSING_RAOM_DUNGEON_AFTER_MINUTE, // 462
	// 20070814 라옴 던전 5층이 폐쇄되었습니다. 미클리즈의 부활을 막지 못했습니다.
	STRID_CLOSED_RAOM_DUNGEON_MIKLLIZZ_REVIVE, // 463
	// 20070814 미클리즈 완전 부활까지 %d분 남았습니다.
	STRID_REMAIN_MINUTE_MIKLLIZZ_REVIVE, // 464
	// 20070814 미클리즈의 부활을 막지 못했습니다.
	STRID_DONOT_STOP_MIKLLIZZ_REVIVE, // 465
	// 20070814 공격 %d번측이 전쟁에 승리했습니다. 10초 뒤에 부활 위치로 이동합니다.
	STRID_VICTORY_ATTACKER_MOVE_REVIVE_POINT, // 466

#ifdef __MENEGROTH_DOUNGEON_SYSTEM__
	// 메네그로스 던전 진입에 필요한 인장이 충분하지 않습니다.
	STRID_NOT_ENOUGH_MENEGROTH_REQUIREDITEM = 467, 	// 467 
	// 메네그로스 던전 이용이 가능한 레벨이 아닙니다
	STRID_NOT_ENOUGH_MENEGROTH_REQUIREDLEVEL, 	// 468 
	// 카브라캄이 나타났습니다.
	STRID_SHOWUP_CABRACAM_MONSTER, 				// 469 
	// 카브라캄이 소환되었습니다..
	STRID_SUMMON_CABRACAM_MONSTER, 				// 470 
	// 카브라캄의 심장을 가지고 있지 않습니다.
	STRID_NOT_ENOUGH_CABRACAM_HEART,			// 471
	// 카브라캄이 이미 소환되었습니다..
	STRID_SUMMON_CABRACAM_MONSTER_ALREADY,		// 472
	STRID_MENEGROTH_DOUNGEON_LIMITED_TIMER,		// 473
#endif // __MENEGROTH_DOUNGEON_SYSTEM__

	STRID_CAN_USE_AFTER_PREMIUM_SERVICE_PAYMENT = 474,	// 474
	STRID_GEARSLOT_CHANGED_DEFAULTSLOT,					// 475
	STRID_GEARSLOT_CHANGED_SUBSLOT,						// 476
	
	STRID_GEARSLOT_CANNOT_USE_PREMIUMCARD_ANYMOIRE = 477,		// 477
	// 장바구니에 이벤트 선물이  도착하였습니다
	STRID_GET_EVENT_PRESENT_IN_SHOPPINGCART = 478,			// 478
