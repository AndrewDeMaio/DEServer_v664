...
public:
	typedef hash_map< string, Creature* > TCreatureMap;
	...
	const hash_map< string, Creature* >& getCreatures() { return m_PCs; }
	...
	NPC* getNPC(const NPCID_t NPCID) const throw();
	NPC* getNPC_LOCKED(const NPCID_t NPCID) const throw();
...
private:
	...
	hash_map< NPCID_t, NPC* > 		m_NPCsByNPCID;
