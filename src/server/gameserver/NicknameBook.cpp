...
void NicknameBook::clear() throw(Error)
{
	__BEGIN_TRY

	hash_map<WORD, NicknameInfo*>::iterator itr = m_Nicknames.begin();
	hash_map<WORD, NicknameInfo*>::iterator endItr = m_Nicknames.end();
