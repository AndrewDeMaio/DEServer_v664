...
#if defined(__CHINA_SERVER__) || defined(__THAILAND_SERVER__) || defined(__JAPAN_SERVER__) || defined(__GLOBAL_SERVER__)
...
#define SYSTEM_RETURN_IF_NOT(KIND) \
		...
		return; }
#define SYSTEM_BEGIN(KIND) \
	if ( SystemAvailabilitiesManager::getInstance()->isAvailable(SystemAvailabilitiesManager::KIND) ) {
#define SYSTEM_BEGIN_IF_NOT(KIND) \
	if ( !SystemAvailabilitiesManager::getInstance()->isAvailable(SystemAvailabilitiesManager::KIND) ) {
#define SYSTEM_END \
	}
...
#if defined(__THAILAND_SERVER__) || defined(__CHINA_SERVER__) || defined(__JAPAN_SERVER__) || defined(__GLOBAL_SERVER__)
...
public:
	enum SystemKind
	{
		...
		SYSTEM_BLOOD_BURST,
		SYSTEM_ADVANCEMENT,
		SYSTEM_SECOND_RANK_BONUS,
		SYSTEM_MASTER_LAIR_GDR,
		SYSTEM_PERSONAL_STORE,
