...
public:
	...
	bool isSingleTarget() const { return m_PropertyType.test( SKILL_PROPERTY_TYPE_SINGLE_TARGET ); }
	void setSingleTarget( bool bSingleTarget )
	{
		( bSingleTarget ? m_PropertyType.set( SKILL_PROPERTY_TYPE_SINGLE_TARGET )
		  				: m_PropertyType.reset( SKILL_PROPERTY_TYPE_SINGLE_TARGET ) );
	}

	bool isWideTarget() const { return m_PropertyType.test( SKILL_PROPERTY_TYPE_WIDE_TARGET ); }
	void setWideTarget( bool bWideTarget )
	{
		( bWideTarget ? m_PropertyType.set( SKILL_PROPERTY_TYPE_WIDE_TARGET )
		  			  : m_PropertyType.reset( SKILL_PROPERTY_TYPE_WIDE_TARGET ) );
	}
