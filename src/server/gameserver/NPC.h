...
public:
	...
	bool activateTrigger(Creature* pCreature, ConditionType_t conditionType, Trigger::TriggerMode triggerMode, void* pParam = NULL);
...
public:
	...
	bool isGlobal(void) const { return m_bGlobal; }
...
//	void setSimpleQuestListScript(Script* pScript) throw (Error);
	...
	void setInstanceDoungeonScript(string& strScript)
	{
		m_strDoungeonScript = strScript;
	}
	
	string& getInstanceDoungeonScript()
	{
		return m_strDoungeonScript;
	}
