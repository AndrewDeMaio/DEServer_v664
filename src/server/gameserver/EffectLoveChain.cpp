...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
bool EffectLoveChain::isValidTargetZone(Creature *pCreature, Zone *pTargetZone)
{
	...
	bValidTargetZone = 
		...
		!pTargetZone->isCastleZone() && !pTargetZone->isHellGardenTower() && pTargetZone->getZoneID() != 5000 && pTargetZone->getZoneID() != 5010 &&
#ifdef __MENEGROTH_DOUNGEON_SYSTEM__
		(pTargetZoneInfo != NULL && !pTargetZoneInfo->isMenegrothDoungeonZone()) &&
#endif
		pTargetZone->getZoneID() != 5020 && pTargetZone->getZoneID() != 5030 && pTargetZone->getZoneID() != 5040 &&
...
//  loginPayPlay 함수는 한번만 불려도 별 상관없어 보인다. CGConnectHandler 에서 이미 불려지고 있다.
                    ...
                    || !( g_pZoneInfoManager->getZoneInfo( pTargetZone->getZoneID() )->isPayPlay() ) )
				{
					...
					{
						if ( isValidTargetZone(pCreature, pTargetZone))
						{
							bValid = true;
