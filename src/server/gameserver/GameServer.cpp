...
#include "ZoneGroupManager.h" // 테스트용 
	 ...
	 throw (Error)
{
	...
	cout << "test1 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test1 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	...
	cout << "test2 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test2 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	...
	cout << "test3 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test3 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	g_pPacketValidator->init();
	cout << "GameServer::init() : PacketValidator Initialization Success..." << endl;

	cout << "test4 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test4 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	// 이제 서버간 통신 준비에 들어간다.
	g_pLoginServerManager->init();
	cout << "GameServer::init() : LoginServerManager Initialization Success..." << endl;
	
	cout << "test5 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test5 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	...
	cout << "test6 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test6 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
#ifdef __CONNECT_BILLING_SYSTEM__
	// shared server 와의 통신 준비에 들어간다.
	g_pBillingPlayerManager->init();
	cout << "GameServer::init() : BillingPlayerManager Initialization Success..." << endl;
	cout << "test7 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test7 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
#endif
	...
	cout << "test8 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test8 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
#endif
	...
	cout << "test9 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test9 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;

    g_pMPlayerManager->init();
    cout << "GameServer::init() : MPlayerManager Initialization Success..." << endl;
	cout << "test10 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test10 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
#endif
#endif

	g_pGameServerInfoManager->init();
	cout << "GameServer::init() : GameServerInfoManager Initialization Success..." << endl;
	cout << "test11 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test11 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;

	// 만반의 준비가 끝이 나면 이제 클라이언트매니저를 초기화함으로써,
	// 네트워킹에 대비한다.
	g_pClientManager->init();
	cout << "GameServer::init() : ClientManager Initialization Success..." << endl;
	cout << "test12 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "test12 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	 ...
	 throw (Error)
{
	...
	cout << "start test1 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test1 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
	
	cout << ">>> STARTING LOGIN SERVER MANAGER..." << endl;
	g_pLoginServerManager->start();
	cout << "start test2 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test2 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;

	cout << ">>> STARTING SHARED SERVER MANAGER..." << endl;
	g_pSharedServerManager->start();
	cout << "start test3 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test3 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;

#ifdef __CONNECT_BILLING_SYSTEM__
	cout << ">>> STARTING BILLING PLAYER MANAGER..." << endl;
	g_pBillingPlayerManager->start();
	cout << "start test4 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test4 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
#endif

#ifdef __CONNECT_CBILLING_SYSTEM__
	cout << ">>> STARTING CBILLING PLAYER MANAGER..." << endl;
	g_pCBillingPlayerManager->start();
	cout << "start test5 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test5 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
#endif

#ifndef __GLOBAL_SERVER__
#ifdef __MOFUS__
    g_pMPlayerManager->start();
	cout << "start test6 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test6 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
    cout << ">>> STARTING MOFUS PLAYER MANAGER..." << endl;
#endif

    //20090618 ksym555
    if (g_pVariableManager->isSMSCheck())
    {
...
#endif
	cout << "start test7 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test7 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;

//	cout << ">>> STARTING Gilles De Rais Lair Manager THREAD..." << endl;
	
	GDRLairManager::Instance().init();
	
	if (g_pVariableManager->isGDRLairContent())
	{
		GDRLairManager::Instance().start();
	}
	cout << "start test8 g_pZoneGroupManager->getZoneGroup(1) : " << g_pZoneGroupManager->getZoneGroup(1) << endl;
	cout << "start test8 g_pZoneGroupManager->getZoneGroup(2) : " << g_pZoneGroupManager->getZoneGroup(2) << endl;
...
/*	if (g_pTestConfig!=NULL)
	...
	////////////////////////////////////////////////////////////////////////
	// Wait for thread's ending
	////////////////////////////////////////////////////////////////////////
	Thread::join( GDRLairManager::Instance() );

#ifndef __GLOBAL_SERVER__	
	Thread::join( SMSServiceThread::Instance() );
#endif

	////////////////////////////////////////////////////////////////////////
	// clearing
	////////////////////////////////////////////////////////////////////////
	cout << "<<< CLEARING GDRLairManager..." << endl;
	GDRLairManager::Instance().clear();

#ifndef __GLOBAL_SERVER__	
	cout << "<<< CLEARING SMSServiceThread..." << endl;
	SMSServiceThread::Instance().clear();
#endif
