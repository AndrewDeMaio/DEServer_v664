...
//		저항공식 적용...
		...
		Damage_t damage = computeMagicDamage(pCreature, m_Point, SKILL_DIVINE_GUIDANCE);
#else
		Damage_t damage = m_Point;
#endif
		GCModifyInformation gcMI, gcAttackerMI;
		setDamage( pCreature, damage, pAttacker, SKILL_DIVINE_GUIDANCE, &gcMI, &gcAttackerMI );
