...
// 뱀파이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType Whitsuntide::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
    throw(Error)
{
    __BEGIN_TRY
...
//////////////////////////////////////////////////////////////////////////////
SkillResultType Whitsuntide::execute(Slayer* pSlayer, ZoneCoord_t X, ZoneCoord_t Y, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
...
*/
						HP_t CurrentHP = getPercentValue(pTargetSlayer->getHP(ATTR_MAX), output.Damage);
						// 2007 02 12 유저가 선택할때까지 시간을 주기 위해 이펙트를 붙인다.
						if( !pTargetSlayer->isFlag( Effect::EFFECT_CLASS_REQUEST_RESURRECT ) )
						{
							EffectRequestResurrect* pEffectRequestResurrect = new EffectRequestResurrect(pTargetSlayer);
							pEffectRequestResurrect->setDuration(100);
							pEffectRequestResurrect->setHP(CurrentHP);
							pTargetSlayer->addEffect(pEffectRequestResurrect);
							pTargetSlayer->setFlag(Effect::EFFECT_CLASS_REQUEST_RESURRECT);
