...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
bool EffectSoulChain::isValidTargetZone(Zone *pTargetZone)
{
...
//	loginPayPlay 함수는 한번만 불려도 별 상관없어 보인다. 
	...
	if ( !bValid )
	{
		executeSkillFailNormal(pCreature, SKILL_SOUL_CHAIN, NULL);
	}
