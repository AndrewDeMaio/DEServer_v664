	...
	throw(Error)
{
	...
	os << "INSERT INTO EffectYellowPoisonToCreature"
	...
	throw(Error)
{
	...
	os << "DELETE FROM EffectYellowPoisonToCreature WHERE OwnerID = '" << ownerID << "'";
	...
	throw(Error)
{
	...
	os << "UPDATE EffectYellowPoisonToCreature SET "
