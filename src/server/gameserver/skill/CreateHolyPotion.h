...
public:
	...
	virtual void execute(Slayer* pSlayer, ObjectID_t, CoordInven_t X, CoordInven_t Y, CoordInven_t TargetX, CoordInven_t TargetY, SlayerSkillSlot* pSkillSlot) throw(Error);
