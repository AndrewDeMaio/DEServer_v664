...
// 슬레이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType  SatelliteBomb::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
    throw(Error)
{
    __BEGIN_TRY
...
// 슬레이어 타일 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType SatelliteBomb::execute(Slayer* pSlayer, ZoneCoord_t X, ZoneCoord_t Y, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		bool bEffected	 = pSlayer->isFlag( Effect::EFFECT_CLASS_SATELLITE_BOMB_AIM );
		...
		if (bManaCheck && bTimeCheck && bRangeCheck && !bEffected && bTileCheck )
		{
			...
			Effect* pOldEffect = tile.getEffect(Effect::EFFECT_CLASS_SATELLITE_BOMB_POINT);
			if (pOldEffect != NULL)
			{
...
//			pEffect->setNextTime(10);
			...
			pSlayer->setFlag( Effect::EFFECT_CLASS_SATELLITE_BOMB_AIM );
...
/*
void SatelliteBomb::execute(Monster* pMonster, ZoneCoord_t X, ZoneCoord_t Y) throw(Error)
{
	__BEGIN_TRY

	try 
	{
		cout << pMonster->getName() << " use satelite Bomb" << endl;
		...
		if (bTileCheck)
		{
			...
			pMonster->setFlag( Effect::EFFECT_CLASS_SATELLITE_BOMB_AIM );
