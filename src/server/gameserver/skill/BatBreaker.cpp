//////////////////////////////////////////////////////////////////////////////
// Filename    : BatBreaker.cpp
// Written by  : excel96
// Description : Bat Breaker (skill 553). Same flow as Bat Storm (a ground effect hitting a 5x5 area three times);
//               damage from the v9 gameserver (BatBreaker).
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
SkillResultType BatBreaker::execute(Vampire* pVampire, ObjectID_t TargetObjectID, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID)
    throw(Error)
{
    __BEGIN_TRY
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
SkillResultType BatBreaker::execute(Vampire* pVampire, ZoneCoord_t X, ZoneCoord_t Y, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
...
//		bool bHitRoll    = HitRoll::isSuccessMagic(pVampire, pSkillInfo, pVampireSkillSlot, HitBonus);
		...
		if (bManaCheck && bTimeCheck && bRangeCheck && bTileCheck)
		{
			...
			Effect* pOldEffect = tile.getEffect(Effect::EFFECT_CLASS_BAT_BREAKER);
			if (pOldEffect != NULL)
			{
...
//			checkMine( pZone, X, Y );
			...
			EffectBatBreaker* pEffect = new EffectBatBreaker(pZone, X, Y, true);
