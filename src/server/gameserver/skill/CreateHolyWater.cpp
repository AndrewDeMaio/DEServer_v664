...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void CreateHolyWater::execute(Slayer * pSlayer , ObjectID_t InvenObjectID, CoordInven_t X, CoordInven_t Y, CoordInven_t TargetX, CoordInven_t TargetY, SlayerSkillSlot * pSkillSlot)
	throw(Error)
{
	__BEGIN_TRY
...
//			decreaseItemNum(pWater, pInventory, pSlayer->getName(), STORAGE_INVENTORY, 0, X, Y);
			...
			{
				if (canStack(pPrevHolyWater, pHolyWater) == false || pPrevHolyWater->getNum() + pHolyWater->getNum() <= ItemMaxStack[pHolyWater->getItemClass()])
				{
