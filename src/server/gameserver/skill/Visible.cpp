...
//
//////////////////////////////////////////////////////////////////////
SkillResultType Visible::execute(Slayer * pSlayer, ZoneCoord_t X, ZoneCoord_t Y, SlayerSkillSlot * pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
				...
				if(pTargetCreature != NULL)
				{
					if(pTargetCreature->isPC())
					{
						...
						if( bHitRoll && bEffected ) {
							...
							Effect* pInvi = pTargetCreature->findEffect( Effect::EFFECT_CLASS_INVISIBILITY );
...
//
//////////////////////////////////////////////////////////////////////
SkillResultType Visible::execute(Slayer * pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot * pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
