...
public:
	SkillInput() {}
	SkillInput(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot);
...
public:
	...
	int             PartySize;
	int 			Distance; // 20080401 시전자와 타겟과의 거리
};
...
{
	SKILL_RESULT_SUCCESS = 0,
	
	SKILL_RESULT_FAIL_UNKNOWN,
	
	SKILL_RESULT_FAIL_NOT_ENOUGH_MP,
	SKILL_RESULT_FAIL_NOT_ENOUGH_HP,
	SKILL_RESULT_FAIL_NOT_ENOUGH_TIME,
	SKILL_RESULT_FAIL_NOT_ENOUGH_HITROLL,
	SKILL_RESULT_FAIL_NOT_ENOUGH_BULLET,
	SKILL_RESULT_FAIL_NOT_ENOUGH_PRECONDITIONS,
	SKILL_RESULT_FAIL_NOT_ENOUGH_INVENTORY_SPACE,
		
	SKILL_RESULT_FAIL_IS_NOT_IN_RANGE,
	SKILL_RESULT_FAIL_IS_NOT_COMA,
	SKILL_RESULT_FAIL_IS_NOT_PARTY,
	
	SKILL_RESULT_FAIL_INVALID_TARGET,
	SKILL_RESULT_FAIL_INVALID_ITEM,
	
	SKILL_RESULT_FAIL_CANNOT_USE_IN_ZONE,
	SKILL_RESULT_FAIL_CANNOT_OVERLAP_EFFECT,
	SKILL_RESULT_FAIL_CANNOT_USE_IN_RACE,
...
public:
	...
	// Skill To Object
	virtual void execute(Creature* pCreature, ObjectID_t ObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID, SkillType_t SkillType) throw(Error);
	...
	virtual void execute(Slayer* pSlayer, ObjectID_t TargetObjectID, ObjectID_t InventoryItemObjectID, CoordInven_t X, CoordInven_t Y, CoordInven_t TargetX, CoordInven_t TargetY, SlayerSkillSlot* pSkillSlot) throw(Error);
	...
	// Skill To Inventory
	virtual void execute(Slayer* pSlayer, ObjectID_t TargetObjectID, CoordInven_t X, CoordInven_t Y, CoordInven_t TargetX, CoordInven_t TargetY, SlayerSkillSlot* pSkillSlot) throw(Error);
	...
	// ex) SoulChain . 
	virtual SkillResultType execute(PlayerCreature* pPC, const string& TargetName, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID) throw(Error);
	...
	virtual void computeOutputByCreature(PlayerCreature* pPC, SkillOutput& output) {}
