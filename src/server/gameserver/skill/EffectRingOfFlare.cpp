...
//		저항공식 적용...
				...
				Damage_t damage = computeMagicDamage(pCreature, m_Damage, SKILL_RING_OF_FLARE);
#else
				...
				if ( pCreature->isPC() )
				{
					...
					::setDamage( pCreature, damage, pCastCreature, SKILL_RING_OF_FLARE, &gcMI, &gcAttackerMI );
				...
				else if ( pCreature->isMonster() )
				{
					...
					::setDamage( pMonster, damage, pCastCreature, SKILL_RING_OF_FLARE, NULL, &gcAttackerMI );
