...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void EffectSpiritGuard::affect(Creature* pEffectedCreature)
	throw(Error)
{
	__BEGIN_TRY
...
//	20080508 SpiritGuard 의 경우 이펙트가 몸에 붙어 다니므로 맵을 이동해도 계속 지속되도록 한다.
...
//		저항공식 적용...
				...
				Damage_t damage = computeMagicDamage(pCreature, m_Damage, SKILL_SPIRIT_GUARD);
#else
...
//					Vampire* pVampire = dynamic_cast<Vampire*>(pCreature);
					...
					::setDamage( pCreature, damage, pEffectedCreature, SKILL_SPIRIT_GUARD, &gcMI, &gcAttackerMI );
				...
				else if ( pCreature->isMonster() )
				{
					...
					::setDamage( pMonster, damage, pEffectedCreature, SKILL_SPIRIT_GUARD, NULL, &gcAttackerMI );
	...
	if ( isHit )
	{
		...
		SlayerSkillSlot* pSkillSlot = pSlayer->getSkill( SKILL_SPIRIT_GUARD );
