...
// 뱀파이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType Seduction::execute(Vampire* pVampire, ObjectID_t TargetObjectID, VampireSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	throw(Error)
{
	...
	bool bEffected   = pEnemy->isFlag(Effect::EFFECT_CLASS_SEDUCTION)
						...
						|| pEnemy->isFlag(Effect::EFFECT_CLASS_BLOOD_CURSE)
						|| pEnemy->isFlag(Effect::EFFECT_CLASS_BLOODS_SYMPOSION_ATTACK);
