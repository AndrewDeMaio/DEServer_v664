...
// 슬레이어 기술 경험치를 계산한다.
void increaseSkillExp(Slayer* pSlayer, SkillDomainType_t DomainType, SlayerSkillSlot* pSkillSlot, SkillInfo* pSkillInfo, ModifyInfo&);
...
// 스킬 성공 후의 처리들
//////////////////////////////////////////////////////////////////////////////
void postSkillSuccessProcess( SkillType_t SkillType, Creature* pAttacker, ModifyInfo* pAttackerMI = NULL );
