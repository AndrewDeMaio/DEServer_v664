...
// 슬레이어 셀프 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType HolySword::execute(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		bool bEffected   = pSlayer->isFlag(Effect::EFFECT_CLASS_HOLY_SWORD);
		...
		if ( bManaCheck && !bEffected )
		{
			...
			pEffect->setEffectClass(Effect::EFFECT_CLASS_HOLY_SWORD);
			pEffect->setDeadline(300);
			pSlayer->setFlag(Effect::EFFECT_CLASS_HOLY_SWORD);
			pSlayer->addEffect(pEffect);
			
			// 패킷을 날린다.
			_GCSkillToSelfOK1.setSkillType(SkillType);
			_GCSkillToSelfOK1.setCEffectID(Effect::EFFECT_CLASS_HOLY_SWORD);
			...
			gcAddEffect.setEffectID( Effect::EFFECT_CLASS_HOLY_SWORD );
