	...
	throw(Error)
{
	...
	pCreature->getViewAbility()->addCanSeeEffect( Effect::EFFECT_CLASS_INVISIBILITY );
	pCreature->getViewAbility()->addCanSeeEffect( Effect::EFFECT_CLASS_SNIPING_MODE );
...
//	pZone->updateInvisibleScan(pCreature);
	...
	ViewAbility prevView = *(pCreature->getViewAbility());
	pCreature->getViewAbility()->removeCanSeeEffect( Effect::EFFECT_CLASS_INVISIBILITY );
	pCreature->getViewAbility()->removeCanSeeEffect( Effect::EFFECT_CLASS_SNIPING_MODE );
