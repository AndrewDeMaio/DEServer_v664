...
SkillResultType SimpleTileCureSkill::execute(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot, 
	...
	throw (Error)
{
	...
	try 
	{
		...
		if (bManaCheck && bTimeCheck && bRangeCheck )
		{
			...
			{
				// Cure Serious Wounds 힐량 두배
				if ( param.SkillType == SKILL_CURE_SERIOUS_WOUNDS )
				{
...
SkillResultType SimpleTileCureSkill::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot* pSkillSlot, 
	const SIMPLE_SKILL_INPUT& param, SIMPLE_SKILL_OUTPUT& result,
	CEffectID_t CEffectID) 
	throw (Error)
{
...
SkillResultType SimpleTileCureSkill::execute(Slayer* pSlayer, ZoneCoord_t X, ZoneCoord_t Y, SlayerSkillSlot* pSkillSlot, 
	const SIMPLE_SKILL_INPUT& param, SIMPLE_SKILL_OUTPUT& result,
	CEffectID_t CEffectID) 
	throw (Error)
{
