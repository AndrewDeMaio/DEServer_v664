...
SkillInput::SkillInput(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot)
{
	Assert(pSlayer != NULL);
...
SkillResultType SkillHandler::execute(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pSlayer != NULL)
	{
...
SkillResultType SkillHandler::execute(Vampire* pVampire, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pVampire != NULL)
	{
...
SkillResultType SkillHandler::execute(Ousters* pOusters, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pOusters != NULL)
	{
...
void SkillHandler::execute(Creature* pCreature, ObjectID_t ObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID, SkillType_t SkillType) 
	throw (Error)
{
...
SkillResultType SkillHandler::execute(Slayer* pSlayer, ObjectID_t ObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pSlayer != NULL)
	{
...
SkillResultType SkillHandler::execute(Vampire* pVampire, ObjectID_t ObjectID, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pVampire != NULL)
	{
...
SkillResultType SkillHandler::execute(Ousters* pOusters, ObjectID_t ObjectID, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pOusters != NULL)
	{
...
SkillResultType SkillHandler::execute(Slayer* pSlayer, ZoneCoord_t X, ZoneCoord_t Y, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pSlayer != NULL)
	{
...
SkillResultType SkillHandler::execute(Vampire* pVampire, ZoneCoord_t X, ZoneCoord_t Y, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pVampire != NULL)
	{
...
SkillResultType SkillHandler::execute(Ousters* pOusters, ZoneCoord_t X, ZoneCoord_t Y, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID) 
	throw (Error)
{
	if (pOusters != NULL)
	{
...
void SkillHandler::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, CoordInven_t X, CoordInven_t Y, CoordInven_t TargetX, CoordInven_t TargetY, SlayerSkillSlot* pSkillSlot) 
	throw (Error)
{
	if (pSlayer != NULL)
	{
...
void SkillHandler::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, ObjectID_t InventoryItemObjectID, CoordInven_t X, CoordInven_t Y, CoordInven_t TargetX, CoordInven_t TargetY, SlayerSkillSlot* pSkillSlot) 
	throw (Error)
{
...
SkillResultType SkillHandler::execute(PlayerCreature* pPC, const string& TargetName, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	if (pPC != NULL)
	{
...
SkillResultType SkillHandler::execute(Slayer* pSlayer, const string& TargetName, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	if (pSlayer != NULL)
	{
...
SkillResultType SkillHandler::execute(Vampire* pVampire, const string& TargetName, VampireSkillSlot* pVampireSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	if (pVampire != NULL)
	{
...
SkillResultType SkillHandler::execute(Ousters* pOusters, const string& TargetName, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	if (pOusters != NULL)
	{
	...
	throw (Error)
{
	...
	execute(pMonster, pMonster->getX(), pMonster->getY());
