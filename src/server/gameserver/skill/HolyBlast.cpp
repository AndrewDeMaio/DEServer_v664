...
// 슬레이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType HolyBlast::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	return g_SimpleTileCureSkill.execute(pSlayer, TargetObjectID, pSkillSlot, param, result);
...
// 슬레이어 셀프 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType HolyBlast::execute(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	return g_SimpleTileCureSkill.execute(pSlayer, pSkillSlot, param, result);
...
SkillResultType HolyBlast::execute(Slayer* pSlayer, ZoneCoord_t X, ZoneCoord_t Y,  SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	return g_SimpleTileCureSkill.execute(pSlayer, X, Y, pSkillSlot, param, result);
...
void HolyBlast::execute(Slayer* pSlayer, int X, int Y, SlayerSkillSlot* pSkillSlot,
