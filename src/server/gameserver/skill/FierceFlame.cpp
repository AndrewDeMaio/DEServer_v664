...
// 아우스터즈 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType FierceFlame::execute(Ousters* pOusters, ObjectID_t TargetObjectID, OustersSkillSlot* pOustersSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		bool bEffected   = pOusters->isFlag(Effect::EFFECT_CLASS_HELLFIRE);// 20080131 헬파이어랑 같이 못쓴다.  

		if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && bCanHit && bPK && bSatisfyRequire && !bEffected)
		{
			...
			// 스킬 후 처리
			postSkillSuccessProcess( getSkillType(), pOusters, &_GCSkillToObjectOK1 );
