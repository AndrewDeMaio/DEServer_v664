	...
	throw(Error)
{
	...
	pCreature->getViewAbility()->addCanSeeEffect( Effect::EFFECT_CLASS_INVISIBILITY, getSkillLevel() - 15 );
	...
	throw(Error)
{
	...
	ViewAbility prevView = *(pSlayer->getViewAbility());
	pSlayer->getViewAbility()->removeCanSeeEffect( Effect::EFFECT_CLASS_INVISIBILITY, getSkillLevel() - 15 );
	pZone->updateViewAbility( pSlayer, prevView );
