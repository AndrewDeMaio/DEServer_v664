//////////////////////////////////////////////////////////////////////////////
// Filename    : SpectorInverse.cpp
// Written by  : 
// Description : Spector Inverse (skill 552). Same flow as Illusion Inversion (holy missile, sometimes
//               drains the target over time and heals the caster); damage from the v9 gameserver.
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
SkillResultType SpectorInverse::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot * pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
...
//
	...
	*/
	...
	int successRatio = min(25, int(input.INTE/20 + (RARE_BOOK_ADVANCEMENT_LEVEL-10)));	// book skills do not grow (Illusion Inversion uses the advancement level)

	if( successRatio < 0 )
		successRatio = 0;

	if( result.bSuccess && pWeapon->getSilver() >= 50 && rand()%100 < successRatio )
	{
		...
		EffectSpectorInverse* pEffect = new EffectSpectorInverse(pTargetCreature);
		...
		pTargetCreature->setFlag(Effect::EFFECT_CLASS_SPECTOR_INVERSE);
		pTargetCreature->addEffect(pEffect);

		gcAddEffect.setObjectID( pTargetCreature->getObjectID() );
		gcAddEffect.setEffectID( Effect::EFFECT_CLASS_SPECTOR_INVERSE);
