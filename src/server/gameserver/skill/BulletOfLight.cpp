...
// 슬레이어 오브젝트
//////////////////////////////////////////////////////////////////////////////
SkillResultType BulletOfLight::execute (Slayer* pSlayer, ObjectID_t TargetObjectID,  SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw (Error)
{
...
//		int ToHitPenalty = getPercentValue( pSlayer->getToHit(), output.ToHit );
		...
		if (bManaCheck && bTimeCheck && bRangeCheck && bBulletCheck && bHitRoll && bPK)
		{
			...
			// 스킬 후 처리
			postSkillSuccessProcess( SkillType, pSlayer, &_GCAttackArmsOK1 );
