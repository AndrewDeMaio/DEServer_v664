//////////////////////////////////////////////////////////////////////////////
// Filename    : TsarBlueRoseDevil.cpp
// Description : Dracula Castle monster skill SKILL_TSAR_BLUE_ROSE_DEVIL (541), cast by Tsar.
...
void TsarBlueRoseDevil::execute(Monster* pMonster, Creature* pEnemy)
	throw(Error)
{
	__BEGIN_TRY
...
void TsarBlueRoseDevil::computeOutput(const SkillInput& input, SkillOutput& output)
{
	output.Delay  = 20;
	output.Damage = (int)(input.DEX * 0.5);
}

TsarBlueRoseDevil g_TsarBlueRoseDevil;
