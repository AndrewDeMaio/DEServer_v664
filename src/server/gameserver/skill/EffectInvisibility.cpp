	...
	throw(Error)
{
	...
	pCreature->getViewable()->addViewEffect( Effect::EFFECT_CLASS_INVISIBILITY, m_Level );
	...
	throw(Error)
{
	...
	Viewable prevViewable = *(pCreature->getViewable());
	pCreature->getViewable()->removeViewEffect( Effect::EFFECT_CLASS_INVISIBILITY, m_Level );
	pCreature->getZone()->updateViewable( pCreature, prevViewable );
