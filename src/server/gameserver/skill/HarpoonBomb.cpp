...
// 슬레이어 오브젝트
//////////////////////////////////////////////////////////////////////////////
SkillResultType HarpoonBomb::execute (Slayer* pSlayer, ObjectID_t TargetObjectID,  SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw (Error)
{
...
//			pWeapon->getItemClass() == Item::ITEM_CLASS_SR)
		...
		bool bBulletCheck = (getRemainBullet(pWeapon) > 10) ? true : false;
