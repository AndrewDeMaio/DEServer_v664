//////////////////////////////////////////////////////////////////////////////
// Filename    : PalusLongRangeMagic.cpp
...
void PalusLongRangeMagic::execute(Monster* pMonster, Creature* pEnemy)
	throw(Error)
{
	__BEGIN_TRY
...
void PalusLongRangeMagic::computeOutput(const SkillInput& input, SkillOutput& output)
{
	output.Delay  = 20;
	output.Damage = (int)(input.DEX * 0.1);
}

PalusLongRangeMagic g_PalusLongRangeMagic;
