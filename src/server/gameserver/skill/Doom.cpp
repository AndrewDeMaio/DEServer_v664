...
// 뱀파이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType Doom::execute(Vampire* pVampire, ObjectID_t TargetObjectID, VampireSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		if (pTargetCreature==NULL
			...
			|| pTargetCreature->isFlag(Effect::EFFECT_CLASS_BLOOD_CURSE)
			|| pTargetCreature->isFlag(Effect::EFFECT_CLASS_BLOODS_SYMPOSION_ATTACK)
