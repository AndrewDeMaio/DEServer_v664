...
// 슬레이어 셀프 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType BurstGun::execute(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		bool bEffected   = pSlayer->isFlag(Effect::EFFECT_CLASS_BURST_GUN);
		...
		if ( bManaCheck && !bEffected )
		{
			...
			pEffect->setEffectClass(Effect::EFFECT_CLASS_BURST_GUN);
			pEffect->setDeadline(300);
			pSlayer->setFlag(Effect::EFFECT_CLASS_BURST_GUN);
			...
			_GCSkillToSelfOK1.setCEffectID(Effect::EFFECT_CLASS_BURST_GUN);
			...
			gcAddEffect.setEffectID( Effect::EFFECT_CLASS_BURST_GUN );
