...
// 슬레이어 셀프 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType MagicShield2::execute(Slayer* pSlayer, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		Level_t			  SkillLevel = pSkillInfo->getLevel();
...
//		bool bHitRoll    = HitRoll::isSuccessMagic(pSlayer, pSkillInfo, pSkillSlot);
		bool bEffected   = pSlayer->isFlag(Effect::EFFECT_CLASS_MAGIC_SHIELD2);
		bool bEffected2  = pSlayer->isFlag(Effect::EFFECT_CLASS_MAGIC_SHIELD1);
		Level_t domainLevel = pSlayer->getSkillDomainLevel(DomainType);
		bool bSkillLevel = (domainLevel >= SkillLevel);

		if (bManaCheck && bTimeCheck && bRangeCheck && !bEffected && !bEffected2 && bSkillLevel)
		{
