...
#ifndef __EFFECT_SATELLITE_BOMB_POINT__
#define __EFFECT_SATELLITE_BOMB_POINT__
...
public:
    EffectClass getEffectClass() const throw() { return EFFECT_CLASS_SATELLITE_BOMB_POINT; }
