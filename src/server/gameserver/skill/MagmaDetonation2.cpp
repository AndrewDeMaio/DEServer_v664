...
// 슬레이어 오브젝트 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType MagmaDetonation2::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
    throw(Error)
{
    __BEGIN_TRY
...
// 슬레이어 타일 핸들러
//////////////////////////////////////////////////////////////////////////////
SkillResultType MagmaDetonation2::execute(Slayer* pSlayer, ZoneCoord_t X, ZoneCoord_t Y, SlayerSkillSlot* pSkillSlot, CEffectID_t CEffectID)
	throw(Error)
{
	__BEGIN_TRY
	...
	try 
	{
		...
		if (bManaCheck && bTimeCheck && bRangeCheck && bTileCheck)
		{
			...
			Effect* pOldEffect = tile.getEffect(Effect::EFFECT_CLASS_MAGMA_DETONATION2);
			if (pOldEffect != NULL)
			{
...
//			checkMine( pZone, X, Y );
			...
			// 이펙트 오브젝트를 생성한다.
			EffectMagmaDetonation2* pEffect = new EffectMagmaDetonation2(pZone, X, Y, true);
...
// 몬스터 타일 핸들러
//////////////////////////////////////////////////////////////////////////////
void MagmaDetonation2::execute(Monster* pMonster, ZoneCoord_t X, ZoneCoord_t Y)
	throw(Error)
{
	__BEGIN_TRY
...
//		bool bHitRoll    = HitRoll::isSuccessMagic(pMonster, pSkillInfo);
		...
		if (bRangeCheck && bTileCheck)
		{
			...
			// 이펙트 오브젝트를 생성한다.
			EffectMagmaDetonation2* pEffect = new EffectMagmaDetonation2(pZone, X, Y);
