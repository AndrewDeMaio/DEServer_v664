...
enum FlagSetType
{
	...
	FLAGSET_TRADE_GIFT_BOX_2006_12,				// 18 - 2006.12 크리스마스 이벤트 선물 상자 교환 여부
	FLAGSET_RECEIVE_GREEN_GIFT_BOX_2006_12,		// 19 - 다른 사람으로부터 녹색 선물 상자를 받았나

	FLAGSET_HELLGARDEN_CLEAR_1,					// 20 - 헬가든 1층 클리어 했는가?
	FLAGSET_HELLGARDEN_CLEAR_2,
	FLAGSET_HELLGARDEN_CLEAR_3,
	FLAGSET_HELLGARDEN_CLEAR_4,
	FLAGSET_HELLGARDEN_CLEAR_5,	

	FLAGSET_HELLGARDEN_SEED_1,					// 20 - 헬가든 씨앗 보상을 받았는가?
	FLAGSET_HELLGARDEN_SEED_2,
	FLAGSET_HELLGARDEN_SEED_3,
	FLAGSET_HELLGARDEN_SEED_4,
	FLAGSET_HELLGARDEN_SEED_5,
