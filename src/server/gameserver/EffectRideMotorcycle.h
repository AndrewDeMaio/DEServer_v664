...
//	EffectRideMotorcycle(Slayer* pOwner, Item* pMotorcycle, ZoneCoord_t motorX, ZoneCoord_t motorY) throw(Error);
	EffectRideMotorcycle(ObjectID_t ownerOID, Zone* pZone, Item* pMotorcycle, ZoneCoord_t motorX, ZoneCoord_t motorY) throw(Error);
	virtual ~EffectRideMotorcycle() throw();
