...
public:
	...
	// set Appear Event Monster
	void setAppearEventMonster( MonsterType_t monsterType ) throw (Error);
	bool isAllEventMonsterNotExist() throw (Error);
	
	void ArrangeMonsterList();
	void ArrangeEventMonsterList();
