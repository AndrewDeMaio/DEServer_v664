...
//	char filename[128];
//	sprintf(filename, "%s/data/SimpleGQuest.xml", g_pConfig->getProperty("HomePath"));
//	m_pXMLInfo->LoadFromFile("/home/darkeden/vs/data/SimpleGQuest.xml");
...
//	SYSTEM_BEGIN(SYSTEM_ADVANCEMENT)
//	{
	if(g_pVariableManager->isAdvanceContent())
	{
		m_pXMLInfo = new XMLTree;
