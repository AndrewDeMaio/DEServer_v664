	...
	throw(Error)
{
	...
	if(pDeadCreature->isFlag(Effect::EFFECT_CLASS_REQUEST_RESURRECT))
	{
		EffectRequestResurrect* pEffect = (EffectRequestResurrect*)pDeadCreature->getEffectManager()->findEffect(Effect::EFFECT_CLASS_REQUEST_RESURRECT);
