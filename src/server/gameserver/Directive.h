...
#define INVALID_DIRECTIVETYPE		0xFFFFFFFF
////////////////////////////////////////////////////////////////////////
// 조건 상수
////////////////////////////////////////////////////////////////////////
...
enum
{
	...
	DIRECTIVE_COND_ENEMY_NOT_FEEBLE_VIRUS,		// 38
...
enum
{
	DIRECTIVE_ACTION_APPROACH = 0,	// 0
	DIRECTIVE_ACTION_APPROACH_FAST,	// 1
	DIRECTIVE_ACTION_FLEE,           // 2
	DIRECTIVE_ACTION_USE_SKILL,      // 3 
	DIRECTIVE_ACTION_FORGET,         // 4
	DIRECTIVE_ACTION_CHANGE_ENEMY,   // 5 
	DIRECTIVE_ACTION_MOVE_RANDOM,    // 6
	DIRECTIVE_ACTION_WAIT,    		 // 7
	DIRECTIVE_ACTION_FAST_FLEE,		 // 8
	DIRECTIVE_ACTION_SAY,			// 9
...
public:
	...
	// 문자열을 파싱해서  DirectiveSet을 생성한다.
	void createDirectiveSet(DirectiveSet *pDirectiveSet, const string& text, const string& deadtext);
protected:
