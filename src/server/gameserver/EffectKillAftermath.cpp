	...
	throw(Error)
{
	...
	os << "INSERT INTO EffectKillAftermath (OwnerID , YearTime, DayTime) VALUES(" 
		<< "'" << ownerID.c_str()
		<< "', " << currentYearTime
		<< ", " << m_Deadline.tv_sec << ")";
	...
	throw(Error)
{
	...
	os << "DELETE FROM EffectKillAftermath WHERE OwnerID = '" << ownerID.c_str() << "'"; 
	...
	throw(Error)
{
	...
	os << "UPDATE EffectKillAftermath SET "
