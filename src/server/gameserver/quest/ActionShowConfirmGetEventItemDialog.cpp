	...
	throw (Error)
{
	...
	else if ( m_Type == "ComebackItem200507" )
		response.setParameter( EVENT_TYPE_200507_COMEBACK_ITEM );
	else if ( m_Type == "ComebackPremiumItem200507" )
		response.setParameter( EVENT_TYPE_200507_COMEBACK_PREMIUM_ITEM );
	else if ( m_Type == "ComebackRecommendItem200507" )
		response.setParameter( EVENT_TYPE_200507_COMEBACK_RECOMMEND_ITEM );
	else
		return;
