////////////////////////////////////////////////////////////////////////////////
// Filename    : ActionTradeMysteryPotion.cpp
// Written By  : 
// Description :
////////////////////////////////////////////////////////////////////////////////
...
const int NEED_ITEM_MAX = 5;
const ITEM_TEMPLATE NeedItemTemplate[NEED_ITEM_MAX] = 
{
	{ Item::ITEM_CLASS_EVENT_STAR, 7, "블루 드롭", 10},
	{ Item::ITEM_CLASS_QUEST_ITEM, 0, "바토리 비쥬", 5},
	{ Item::ITEM_CLASS_QUEST_ITEM, 2, "테페즈 비쥬", 5},
	{ Item::ITEM_CLASS_QUEST_ITEM, 8, "질드레 비쥬", 1},
	{ Item::ITEM_CLASS_COMMON_QUEST_ITEM, 4, "깨끗한 가죽", 20},
};

const ITEM_TEMPLATE ExchangeItemTemplate[1] =
{
	{ Item::ITEM_CLASS_EFFECT_ITEM, 27, "의문의 물약", 1},
};

////////////////////////////////////////////////////////////////////////////////
// ActionTradeMysteryPotion
////////////////////////////////////////////////////////////////////////////////
ActionTradeMysteryPotion::ActionTradeMysteryPotion()
{
}
...
// 
////////////////////////////////////////////////////////////////////////////////
void ActionTradeMysteryPotion::read(PropertyBuffer & propertyBuffer)
    throw (Error)
{
    __BEGIN_TRY
...
// 액션을 실행한다.
////////////////////////////////////////////////////////////////////////////////
void ActionTradeMysteryPotion::execute(Creature * pCreature1 , Creature * pCreature2) 
	throw (Error)
{
	__BEGIN_TRY
	...
	int		tradeitemNum[NEED_ITEM_MAX] = { 0, 0, 0 };
	bool	bTradeOK = true;
...
// get debug string
////////////////////////////////////////////////////////////////////////////////
string ActionTradeMysteryPotion::toString () const 
	throw ()
{
	__BEGIN_TRY

	StringStream msg;
	msg << "ActionTradeMysteryPotion("
	    << ")";
	return msg.toString();
