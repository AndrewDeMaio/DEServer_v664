...
//	if ( !pLevelWarManager->hasWar() && !g_pVariableManager->canEnterLevelWarZoneFree() && !pGamePlayer->isPayPlaying() && !pLevelWarManager->canEnterFreeUser() )
	if ( !pLevelWarManager->hasWar() && !g_pVariableManager->canEnterLevelWarZoneFree() && !pGamePlayer->isPremiumPlay() && !pLevelWarManager->canEnterFreeUser() ) // 20080227 유료존 티켓 추가로 수정
	{
