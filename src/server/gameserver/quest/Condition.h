...
public:
	...
	enum ConditionTypes 
	{
		...
		CONDITION_ENTER_MIKLLIZZ_LAIR,		// 미클리즈레어에 들어갈 수 있는가?
		// 2007 06 24
		CONDITION_ENTER_HELLGARDEN_TOWER,		// 헬가든 타워에 들어갈수 있는가?

#ifdef __MENEGROTH_DOUNGEON_SYSTEM__
		// 2007.12.17
		CONDITION_CAN_ENTER_MENEGROTH,		// Can Menegroth Doungeon enter ?
