...
{
public:
	virtual ActionType_t getActionType() const throw() { return ACTION_REGISTER_REINFORCE; }
...
{
public:
	virtual ActionType_t getActionType() const throw() { return Action::ACTION_REGISTER_REINFORCE; }
	virtual string getActionName() const throw() { return "RegisterReinforce"; }
	virtual Action* createAction() const throw() { return new ActionRegisterReinforce(); }
};
#endif
