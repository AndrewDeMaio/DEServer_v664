...
public:
	...
	enum ActionTypes 
	{
		...
		ACTION_BLITZ_REGISTER, 	// 20080829 블리츠 문양 등록
		ACTION_BLITZ_REWARD,	// 20080829 블리츠 이벤트 보상

		ACTION_MAPLE_REGISTER, 	// 20080925 메이플 문양 등록
		ACTION_MAPLE_REWARD,	// 20080925 메이플 이벤트 보상
