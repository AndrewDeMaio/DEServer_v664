...
{
public:
	virtual ActionType_t getActionType() const throw() { return ACTION_ACTIVATE_MAZE_ENTER; }
...
{
public:
	virtual ActionType_t getActionType() const throw() { return Action::ACTION_ACTIVATE_MAZE_ENTER; }
	virtual string getActionName() const throw() { return "ActivateMazeEnter"; }
	virtual Action* createAction() const throw() { return new ActionActivateMazeEnter(); }
};
#endif
