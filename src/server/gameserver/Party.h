...
class TraversePartyMemberCommand
{
public :
	virtual ~TraversePartyMemberCommand() {}

	virtual void Execute(Creature *pCreature) {}
};
...
public:
	...
	void TraversePartyMember(TraversePartyMemberCommand *pTraversePartyMemberCommand);
...
public:
	...
	void increasePartyBloodBurstPoint( Attr_t point ) { m_PartyBloodBurstPoint = min( m_PartyBloodBurstPoint + point, (int)PARTY_BLOOD_BURST_POINT_MAX ); }
	void resetPartyBloodBurstPoint() { m_PartyBloodBurstPoint = 0; }
...
protected:
	...
	Attr_t                       m_PartyBloodBurstPoint;	// 파티 폭주 포인트
};
...
class TraversePartyCommand
{
public :
	virtual ~TraversePartyCommand() {}

	virtual void Execute(Party *pParty) {}
};
...
public:
	...
	void TraverseParty(TraversePartyCommand *pTraversePartyCommand);
...
public:
	...
	//////////////////////////////////////////////////////////////
protected:
	void broadcastPartyBloodBurstPoint_NOLOCKED( Party* pParty );
public:
	void increasePartyBloodBurstPoint( int ID, Attr_t point );
	void resetPartyBloodBurstPoint( int ID );
