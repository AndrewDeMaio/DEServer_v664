...
HP_t         computeTestModeHP(Creature* pCreature, BASIC_ATTR* pAttr, int enhance=0);
...
// 20070918
Defense_t    computeMagicDefense(Creature::CreatureClass CClass, BASIC_ATTR* pAttr, int enhance=0);
ToHit_t      computeMagicToHit(Creature::CreatureClass CClass, BASIC_ATTR* pAttr, int enhance=0);
