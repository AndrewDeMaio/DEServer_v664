	...
	throw (Error)
{
	...
	os << "INSERT INTO EnemyErase (OwnerID , YearTime, DayTime, EnemyName) VALUES (" 
		<< "'" << ownerID.c_str()
		<< "', " << currentYearTime
		<< ", " << m_Deadline.tv_sec
		<< ", '" << m_EnemyName.c_str() << "')";
	...
	throw (Error)
{
	...
	os << "DELETE FROM EnemyErase WHERE OwnerID = '" << ownerID.c_str() << "' AND EnemyName = '" << m_EnemyName.c_str() << "'"; 
	...
	throw (Error)
{
	...
	os << "UPDATE EnemyErase SET "
		<< "YearTime = " << currentYearTime
		<< ", DayTime = " << m_Deadline.tv_sec
		<< ", EnemyName = '" << m_EnemyName.c_str()
