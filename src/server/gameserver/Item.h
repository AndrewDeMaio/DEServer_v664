...
const string ItemClass2ShortString[] = 
{
	...
	"MITTEN",				// 89
	"SUB_INVENTORY",		// 90
	"COMMON_QUEST_ITEM",	// 91
	"ETHEREAL_CHAIN",		// 92
	// 2006.05.22 아우스터스 커플링 대용
	"HARMONIC_PENDENT",	// 93
	"CHECK_MONEY",		// 94
	"CUE_OF_ADAM",		// 95
	"CONTRACT_OF_BLOOD",// 96
	//20070821
	"SKILL_BOOK", // 97

	"VAMPIRE_WING_ITEM",	// 98
	"OUSTERS_WING_ITEM",	// 99
	// 20080604
	"SLAYER_TUNNING_ITEM",	// 100
	"VAMPIRE_TUNNING_ITEM",	// 101
	"OUSTERS_TUNNING_ITEM",	// 102
...
const string ItemObjectTableName[] = 
{
	...
	"CommonQuestItemObject",		// 91
	"EtherealChainObject",			// 92
	// 2006.05.22 아우스터스 커플링 대용
	"HarmonicPendentObject",		// 93
	"CheckMoneyObject",				// 94
	"CueOfAdamObject",				// 95
	"ContractOfBloodObject",		// 96
	//20070821
	"SkillBookObject",				// 97

	"VampireWingItemObject",		// 98
	"OustersWingItemObject",		// 99
	//20080604
	"SlayerTunningItemObject",		// 100
	"VampireTunningItemObject",		// 101
	"OustersTunningItemObject",		// 102
	
	"CallNPCCardObject"			// 103
};
...
//#endif
	...
	50, //LUCKY_BAG            // 77
	 ...
	 1, //MITTEN				// 89
	 1, //SUB_INVENTORY			// 90
	50,	//COMMON_QUEST_ITEM		// 91
	 1, //ETHEREAL_CHAIN		// 92
	// 2006.05.22 아우스터스 커플링 대용
	 1, //HARMONIC_PENDENT		// 93
	 1, //CHECK_MONEY			// 94
	 1, //CUE_OF_ADAM			// 95
	 1,	//CONTACT_OF_BLOOD		// 96
	 // 20070821
	 1,	//SKILL_BOOK			// 97

	 1,	//VAMPIRE_WING_ITEM		// 98
	 1,	//OUSTERS_WING_ITEM		// 99
	// 20080604
	 1,	//SLAYER_TUNNING_ITEM	// 100
	 1,	//VAMPIRE_TUNNING_ITEM	// 101
	 1,	//OUSTERS_TUNNING_ITEM	// 102
...
public:
	...
	enum CreateType 
	{
		...
		CREATE_TYPE_SUPPLY,			// 프리미엄 계정 요일별 보급 아이템		// 12

		CREATE_TYPE_MAX
	};
	
	static ItemClass getItemClass(string& strItemClass);
...
//	virtual Item* getTreasure() const throw() { return NULL; };
	...
	virtual bool hasThirdOptionType() const throw() { return false; }
	virtual int getThirdOptionTypeSize() const throw() { return 0; }
	virtual const list<OptionType_t>& getThirdOptionTypeList() const throw() { static list<OptionType_t> nullList; return nullList; }
	virtual void removeThirdOptionType(OptionType_t OptionType) throw() {}
	virtual void changeThirdOptionType(OptionType_t currentOptionType, OptionType_t newOptionType) throw() {}
	virtual void addThirdOptionType(OptionType_t OptionType) throw() {}
	virtual void setThirdOptionType(const list<OptionType_t>& OptionType) throw() {}
	virtual void clearThirdOption() throw() {}
	virtual BYTE getThirdEnchantType() const throw() { return 0; }
	virtual void setThirdEnchantType(const BYTE thirdEnchantType) throw() { }
#endif
	...
	virtual int getMagicProtectionBonus() const throw(Error) { return 0; } // 20080703  
	...
	virtual bool		hasSubInventory() const { return false; }
	virtual Inventory*	getSubInventory() const { return NULL; }
