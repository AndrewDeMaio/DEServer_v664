...
{
public:
	typedef hash_map<DWORD, GQuestStatus*>				HashMapGQuestStatus;
	typedef HashMapGQuestStatus::iterator				HashMapGQuestStatusItr;
	typedef HashMapGQuestStatus::const_iterator			HashMapGQuestStatusConstItr;
...
public:
	...
	void killed();
	void skillLevelUp(SlayerSkillSlot* pSkillSlot);
	void rideMotorcycle(bool isParty=false);
	void touchWayPoint(PlayerCreature *pPC);
...
private:
	...
	HashMapGQuestStatus	m_QuestStatuses;
