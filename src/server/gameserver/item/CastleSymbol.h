...
public:
	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_CASTLE_SYMBOL; }
	virtual string getObjectTableName() const throw() { return "CastleSymbolObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_CASTLE_SYMBOL; }
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_CASTLE_SYMBOL; }
	virtual string getItemClassName() const throw() { return "CastleSymbol"; }
