...
class OustersChakram : public ConcreteItem<Item::ITEM_CLASS_OUSTERS_CHAKRAM, NoStack, HasDurability, HasOption, WeaponGrade, Weapon>
{
public:
...
private:
	...
	Range_t        m_Range;
	ToHit_t        m_ToHitBonus; // 20080709 다시적용
	Speed_t        m_Speed;
	uint           m_ItemLevel;
