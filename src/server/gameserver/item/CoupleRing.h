...
public:
	virtual ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_COUPLE_RING; }
	virtual string getObjectTableName() const throw() { return "CoupleRingObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_COUPLE_RING; }
	virtual string toString() const throw();
...
public:
	virtual Item::ItemClass getItemClass() const throw() { return Item::ITEM_CLASS_COUPLE_RING; }
	virtual string getItemClassName() const throw() { return "CoupleRing"; }
