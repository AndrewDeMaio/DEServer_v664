...
#ifdef __CONTRIBUTION_SYSTEM__ 
				case 1:
					EClass = Effect::EFFECT_CLASS_SLAYER_HERO_ITEM;
					break;
				case 2:
					EClass = Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM;
					break;
				case 3:
					EClass = Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM;
					break;
				case 4:
					EClass = Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM;
					break;
				case 5:
					EClass = Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM;
					break;
				case 6:
					EClass = Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM;
					break;
...
#ifdef __CONTRIBUTION_SYSTEM__ 
		case 1:
			effectClass = Effect::EFFECT_CLASS_SLAYER_HERO_ITEM;
			break;
		case 2:
			effectClass = Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM;
			break;
		case 3:
			effectClass = Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM;
			break;
		case 4:
			effectClass = Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM;
			break;
		case 5:
			effectClass = Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM;
			break;
		case 6:
			effectClass = Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM;
			break;
#endif /* __CONTRIBUTION_SYSTEM__ */
		}
		...
		case 0:
			{
				...
				pEffect = new EffectDragonEye(pCreature);
		...
		case 1:
			{
				effectClass = Effect::EFFECT_CLASS_SLAYER_HERO_ITEM;
				effectClassSend = effectClass;
				pEffect = new EffectSlayerHeroItem(pCreature);
				EffectSlayerHeroItem* pEffectHeroItem = dynamic_cast<EffectSlayerHeroItem*>(pEffect);
				pEffectHeroItem->setItemID( pItem->getItemID() );
			}
			break;
		case 2:
			{
				effectClass = Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM;
				effectClassSend = effectClass;
				pEffect = new EffectVampireHeroItem(pCreature);
				EffectVampireHeroItem* pEffectHeroItem = dynamic_cast<EffectVampireHeroItem*>(pEffect);
				pEffectHeroItem->setItemID( pItem->getItemID() );
			}
			break;
		case 3:
			{
				effectClass = Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM;
				effectClassSend = effectClass;
				pEffect = new EffectOustersHeroItem(pCreature);
				EffectOustersHeroItem* pEffectHeroItem = dynamic_cast<EffectOustersHeroItem*>(pEffect);
				pEffectHeroItem->setItemID( pItem->getItemID() );
			}
			break;
		case 4:
			{
				effectClass = Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM;
				effectClassSend = effectClass;
				pEffect = new EffectSlayerLevelWarHeroItem(pCreature);
				EffectSlayerLevelWarHeroItem* pEffectHeroItem = dynamic_cast<EffectSlayerLevelWarHeroItem*>(pEffect);
				pEffectHeroItem->setItemID( pItem->getItemID() );
			}
			break;
		case 5:
			{
				effectClass = Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM;
				effectClassSend = effectClass;
				pEffect = new EffectVampireLevelWarHeroItem(pCreature);
				EffectVampireLevelWarHeroItem* pEffectHeroItem = dynamic_cast<EffectVampireLevelWarHeroItem*>(pEffect);
				pEffectHeroItem->setItemID( pItem->getItemID() );
			}
			break;
		case 6:
			{
				effectClass = Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM;
				effectClassSend = effectClass;
				pEffect = new EffectOustersLevelWarHeroItem(pCreature);
				EffectOustersLevelWarHeroItem* pEffectHeroItem = dynamic_cast<EffectOustersLevelWarHeroItem*>(pEffect);
				pEffectHeroItem->setItemID( pItem->getItemID() );
			}
			break;		
#endif /* __CONTRIBUTION_SYSTEM__ */
...
#ifdef __CONTRIBUTION_SYSTEM__
	if ( pCreature->isFlag(Effect::EFFECT_CLASS_SLAYER_HERO_ITEM) )
	{
		...
		if ( g_pWarSystem->hasActiveRaceWar() )
			g_pHeroItemManager->warpToDefaultPosition( pCreature );

		Effect* pEffect = pCreature->findEffect( Effect::EFFECT_CLASS_SLAYER_HERO_ITEM );
		if ( pEffect != NULL )
		{
			pCreature->removeFlag( Effect::EFFECT_CLASS_SLAYER_HERO_ITEM );
			pEffect->unaffect();
			pCreature->deleteEffect( Effect::EFFECT_CLASS_SLAYER_HERO_ITEM );
		}
		return true;
	}
	if ( pCreature->isFlag(Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM) )
	{
		PlayerCreature* pPC = dynamic_cast<PlayerCreature*>(pCreature);
		Assert( pPC != NULL );
		...
		Effect* pEffect = pCreature->findEffect( Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM );
		if ( pEffect != NULL )
		{
			pCreature->removeFlag( Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM );
			pEffect->unaffect();
			pCreature->deleteEffect( Effect::EFFECT_CLASS_VAMPIRE_HERO_ITEM );
		}
		return true;
	}
	if ( pCreature->isFlag(Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM) )
	{
		PlayerCreature* pPC = dynamic_cast<PlayerCreature*>(pCreature);
		Assert( pPC != NULL );
		...
		Effect* pEffect = pCreature->findEffect( Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM );
		if ( pEffect != NULL )
		{
			pCreature->removeFlag( Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM );
			pEffect->unaffect();
			pCreature->deleteEffect( Effect::EFFECT_CLASS_OUSTERS_HERO_ITEM );
		}
		return true;
	}

	if ( pCreature->isFlag(Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM) )
	{
		PlayerCreature* pPC = dynamic_cast<PlayerCreature*>(pCreature);
		Assert( pPC != NULL );
		...
		if ( pZone->hasLevelWar() )
			pZone->warpToLevelWarItemDefaultPosition( pCreature );

		Effect* pEffect = pCreature->findEffect( Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM );
		if ( pEffect != NULL )
		{
			pCreature->removeFlag( Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM );
			pEffect->unaffect();
			pCreature->deleteEffect( Effect::EFFECT_CLASS_SLAYER_LEVELWAR_HERO_ITEM );
		}
		return true;
	}
	if ( pCreature->isFlag(Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM) )
	{
		PlayerCreature* pPC = dynamic_cast<PlayerCreature*>(pCreature);
		Assert( pPC != NULL );
		...
		Effect* pEffect = pCreature->findEffect( Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM );
		if ( pEffect != NULL )
		{
			pCreature->removeFlag( Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM );
			pEffect->unaffect();
			pCreature->deleteEffect( Effect::EFFECT_CLASS_VAMPIRE_LEVELWAR_HERO_ITEM );
		}
		return true;
	}
	if ( pCreature->isFlag(Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM) )
	{
		PlayerCreature* pPC = dynamic_cast<PlayerCreature*>(pCreature);
		Assert( pPC != NULL );
		...
		Effect* pEffect = pCreature->findEffect( Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM );
		if ( pEffect != NULL )
		{
			pCreature->removeFlag( Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM );
			pEffect->unaffect();
			pCreature->deleteEffect( Effect::EFFECT_CLASS_OUSTERS_LEVELWAR_HERO_ITEM );
		}
		return true;
	}
#endif
				...
				else if ( pItem != NULL && pItem->getItemClass() == Item::ITEM_CLASS_SUB_INVENTORY )
				{
					...
					for ( CoordInven_t sy = 0; sy < pSubInventory->getHeight(); ++sy )
					{
						for ( CoordInven_t sx = 0; sx < pSubInventory->getWidth(); ++sx )
						{
							...
							if ( pSubItem != NULL
								&& isRelicItem( pSubItem ) )
							{
								// 일단 아이템을 바닥에 떨어뜨린다.
								if ( dropRelicToZone( pPC, pSubItem ) )
								{
									// 인벤토리에서 뺀다.
