...
//////////////////////////////////////////////////////////////////////////////
//
// class ScriptPortal member methods
//
//////////////////////////////////////////////////////////////////////////////
ScriptPortal::ScriptPortal(ObjectID_t id) 
	throw() : Portal(id)
{
}

bool ScriptPortal::activate(Creature* pCreature) 
	throw (Error)
{
	Assert(pCreature != NULL);
	Assert(pCreature->isPC());
	
	DynamicZoneScript *pDynamicZoneScript;
	
	pDynamicZoneScript = InstanceDoungeonManager::CreateInstanceDoungeon(m_strDungeonID.c_str(), m_iDoungeonIndex);
...
string ScriptPortal::toString() const throw()
{
	__BEGIN_TRY
