...
const Gold_t REQUIRE_SLAYER_MASTER_GOLD 	= 70000000;
const Gold_t REQUIRE_VAMPIRE_MASTER_GOLD	= 70000000;
const Gold_t REQUIRE_OUSTERS_MASTER_GOLD	= 70000000;

const Gold_t REQUIRE_SLAYER_SUBMASTER_GOLD	=  10000000;
const Gold_t REQUIRE_VAMPIRE_SUBMASTER_GOLD	=  10000000;
const Gold_t REQUIRE_OUSTERS_SUBMASTER_GOLD	=  10000000;

const Gold_t RETURN_SLAYER_MASTER_GOLD		= 35000000;
const Gold_t RETURN_VAMPIRE_MASTER_GOLD		= 35000000;
const Gold_t RETURN_OUSTERS_MASTER_GOLD		= 35000000;

const Gold_t RETURN_SLAYER_SUBMASTER_GOLD		= 5000000;
const Gold_t RETURN_VAMPIRE_SUBMASTER_GOLD		= 5000000;
const Gold_t RETURN_OUSTERS_SUBMASTER_GOLD		= 5000000;
...
///// GuildMember get/add/delete/modify /////
	...
	int getActiveMemberCountFromDB() const throw();
	Level_t getAverageLevelOfMember() const throw();
#endif
