...
public:
	...
	void AddPlayer(const string& strName, Player *pPlayer);
	void RemovePlayer(const string& strName);
	
	Player *GetPlayer(const string& strName);
