...
void GameServerManager::AddPlayer(const string& strName, Player *pPlayer)
{
	m_PlayerMap[strName] = pPlayer;
}

void GameServerManager::RemovePlayer(const string& strName)
{
	TPlayerMap::iterator iter;
	
	iter = m_PlayerMap.find(strName);
...
Player *GameServerManager::GetPlayer(const string& strName)
{
	TPlayerMap::iterator iter;
